...
$WT_IMAGES['favorite']['large'] = WT_THEME_DIR.'images/fav.gif';
...
$WT_IMAGES['lists']['large'] = WT_THEME_DIR.'images/lists.gif';
$WT_IMAGES['media']['large'] = WT_THEME_DIR.'images/media.gif';
$WT_IMAGES['menu_repository']['large'] = WT_THEME_DIR.'images/menu_repository.gif';
$WT_IMAGES['menu_source']['large'] = WT_THEME_DIR.'images/menu_source.gif';
...
$WT_IMAGES['printer']['large'] = WT_THEME_DIR.'images/printer.gif';
...
$WT_IMAGES['edit_indi']['large'] = WT_THEME_DIR.'images/edit_indi.gif';
$WT_IMAGES['edit_media']['large'] = WT_THEME_DIR.'images/edit_indi.gif';
$WT_IMAGES['edit_note']['large'] = WT_THEME_DIR.'images/edit_indi.gif';
$WT_IMAGES['edit_sour']['large'] = WT_THEME_DIR.'images/edit_sour.gif';
$WT_IMAGES['edit_repo']['large'] = WT_THEME_DIR.'images/Sedit_repo.gif';
...
$WT_IMAGES['childless']['small'] = WT_THEME_DIR.'images/small/childless.gif';
...
$WT_IMAGES['edit_media']['small'] = WT_THEME_DIR.'images/small/edit_media.gif';
$WT_IMAGES['edit_note']['small'] = WT_THEME_DIR.'images/small/edit_note.gif';
...
$WT_IMAGES['favorite']['small'] = WT_THEME_DIR.'images/small/fav.gif';
...
$WT_IMAGES['home']['small'] = WT_THEME_DIR.'images/small/home.gif';
...
$WT_IMAGES['lists']['small'] = WT_THEME_DIR.'images/small/lists.gif';
...
$WT_IMAGES['printer']['small'] = WT_THEME_DIR.'images/small/printer.gif';
...
$WT_IMAGES['refresh']['button'] = WT_THEME_DIR.'images/buttons/refresh.gif';
