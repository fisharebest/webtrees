...
$controller
	...
	->setPageTitle(WT_I18N::translate('Sidebars'));
...
<form method="post">
	...
	<table id="module_table" class="table table-bordered">
		<thead>
		<tr>
			<th class="col-xs-1"><?php echo WT_I18N::translate('Sidebar'); ?></th>
						...
						<tbody>
							<?php foreach (WT_Tree::getAll() as $tree): ?>
								<tr>
									...
									<td>
										<?php echo edit_field_access_level('access-' . $module->getName() . '-' . $tree->tree_id, $module->getAccessLevel($tree, 'sidebar')); ?>
									</td>
								</tr>
							<?php endforeach; ?>
						</tbody>
