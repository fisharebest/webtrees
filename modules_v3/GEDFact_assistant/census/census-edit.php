...
global $censyear, $censdate;
global $spouselinks, $parentlink;
...
switch (WT_LOCALE) {
case 'de':
	$wiki_link = FunctionsPrint::wikiHelpLink('de/Volksz%C3%A4hlungs-Modul');
	break;
case 'fr':
	$wiki_link = FunctionsPrint::wikiHelpLink('fr/Module_Assistant_Recensement');
	break;
default:
	$wiki_link = FunctionsPrint::wikiHelpLink('en/Census_Assistant_module');
	break;
}
...
?>
<script src="<?php echo WT_STATIC_URL . WT_MODULES_DIR; ?>GEDFact_assistant/census/dynamicoptionlist.js"></script>
<script src="<?php echo WT_STATIC_URL . WT_MODULES_DIR; ?>GEDFact_assistant/census/date.js"></script>
<script>
...
<div id="edit_interface-page">
	...
	<div class="cens_header">
		<div class="cens_header_left">
			<?php echo I18N::translate('Head of household'); ?><?php echo $person->getFullName(); ?>
		</div>
		<div class="cens_header_right">
			<?php echo $person->formatFirstMajorFact(WT_EVENTS_BIRT, 2); ?>
			<?php echo $person->formatFirstMajorFact(WT_EVENTS_DEAT, 2); ?>
		</div>
	</div>
	...
	<form method="post" action="edit_interface.php" onsubmit="return check_form(this);">
		...
		<div class="cens_container">
			...
			<div class="optionbox cens_sour">
				<div class="cens_sour_country">
					<div><?php echo I18N::translate('Country'); ?></div>
				...
				<div class="cens_sour_year">
					...
					<select style="background:#ffaaaa;" onchange="if (this.options[this.selectedIndex].value!='') { changeYear(this.options[this.selectedIndex].value); }" id="censYear" name="censYear">
					</select>
		...
		<div class="optionbox cens_search" style="overflow:-moz-scrollbars-horizontal;overflow-x:hidden;overflow-y:scroll;">
						...
						<table class="fact_table">
							...
							foreach ($families as $family) {
								...
								if ($family->getHusband()) {
									...
									$menu  = new Menu($label);
									CensusAssistantModule::printPedigreePersonNavCensus($gparent->getXref(), $label, $censdate);
									...
									<tr>
										...
										<td align="left" class="facts_value" style="text-decoration:none;">
											<a
												href="edit_interface.php?action=addnewnote_assisted&amp;noteid=newnote&amp;xref=<?php echo $gparent->getXref(); ?>&amp;gedcom="<?php echo $gparent->getTree()->getNameUrl(); ?>
											">
											<?php echo $headImg2; ?>
											</a>
										</td>
								...
								if ($family->getWife()) {
									...
									$label = Functions::getCloseRelationshipName($person, $gparent);
									$menu  = new Menu($label);
									CensusAssistantModule::printPedigreePersonNavCensus($gparent->getXref(), $label, $censyear);
									$submenu = new Menu($parentlinks);
									$menu->addSubmenu($submenu);
									?>
									<tr>
								...
								foreach ($family->getChildren() as $child) {
									...
									$menu  = new Menu($label);
									CensusAssistantModule::printPedigreePersonNavCensus($child->getXref(), $label, $censyear);
