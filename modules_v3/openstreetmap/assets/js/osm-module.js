...
window.WT_OSM = (function() {
	 ...
	 * @private
	 */
	let _initialize = function (reference, tree, mapType, generations) {
		...
		$.getJSON('module.php', {
			...
			.always(function (data_jqXHR, textStatus, jqXHR_errorThrown) {
				_drawMap();
				_addLayer(reference, tree, mapType, generations);
			});
	};
