...
<?php elseif (Filter::get('action') === 'email'): ?>
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<textarea class="form-control" maxlength="2000" id="WELCOME_TEXT_AUTH_MODE_4" name="WELCOME_TEXT_AUTH_MODE_4" rows="10"><?php echo Filter::escapeHtml(Site::getPreference('WELCOME_TEXT_AUTH_MODE_' . WT_LOCALE)); ?></textarea>
			<p class="small text-muted">
