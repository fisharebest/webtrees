...
case 'site':
	...
	header('Location: ' . WT_SERVER_NAME . WT_SCRIPT_PATH . WT_SCRIPT_NAME . '?section=site');
...
case 'email':
	...
	header('Location: ' . WT_SERVER_NAME . WT_SCRIPT_PATH . WT_SCRIPT_NAME . '?section=email');
...
case 'login':
	...
	header('Location: ' . WT_SERVER_NAME . WT_SCRIPT_PATH . WT_SCRIPT_NAME . '?section=login');

	return;
}

switch (WT_Filter::get('section')) {
case 'site':
...
<form method="post" class="form-horizontal">
	...
	<?php if (WT_Filter::get('section') === 'site'): ?>
	...
	<?php elseif (WT_Filter::get('section') === 'email'): ?>
	...
	<?php elseif (WT_Filter::get('section') === 'login'): ?>
