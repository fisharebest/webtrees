...
// require_once 'Zend/Database/Adapter/Pdo/Abstract.php';

/** @see Zend_Db_Abstract_Pdo_Ibm_Db2 */
// require_once 'Zend/Database/Adapter/Pdo/Ibm/Db2.php';

/** @see Zend_Db_Abstract_Pdo_Ibm_Ids */
// require_once 'Zend/Database/Adapter/Pdo/Ibm/Ids.php';

/** @see Zend_Db_Statement_Pdo_Ibm */
// require_once 'Zend/Database/Statement/Pdo/Ibm.php';
...
class Zend_Db_Adapter_Pdo_Ibm extends Zend_Db_Adapter_Pdo_Abstract
{
    ...
    public function _connect()
    {
        ...
        try {
            ...
            // require_once 'Zend/Database/Adapter/Exception.php';
