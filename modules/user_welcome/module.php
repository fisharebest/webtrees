...
class user_welcome_WT_Module extends WT_Module implements WT_Module_Block {
	...
	public function getBlock($block_id) {
		...
		if (get_user_setting(WT_USER_ID, 'editaccount')=='Y') {
			$content .= "<td class=\"center details2\" style=\" width: 33%; clear: none; vertical-align: top; margin-top: 2px;\"><a href=\"edituser.php\"><img src=\"".$WT_IMAGE_DIR."/".$WT_IMAGES["mypage"]["small"]."\" border=\"0\" alt=\"".i18n::translate('My account')."\" title=\"".i18n::translate('My account')."\" /><br />".i18n::translate('My account')."</a></td>";
		}
