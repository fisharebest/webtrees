...
class recent_changes_WT_Module extends WT_Module implements WT_Module_Block {
    ...
    public function getBlock($block_id, $template=true, $cfg=null) {
        ...
        $title.= WT_I18N::translate('Last %s days changes', $days) . help_link('recent_changes', $this->getName());
        $content = "";
        // Print block content
    ...
    public function configureBlock($block_id) {
        ...
        echo '</td><td class="optionbox">';
        echo select_edit_control('sortStyle', array('name' => WT_I18N::translate('Alphabetically'), 'date_asc' => WT_I18N::translate('By Date (ascending)'), 'date_desc' => WT_I18N::translate('By Date (descending)')), null, $sortStyle, '');
        echo '</td></tr>';

        $show_parents = get_block_setting($block_id, 'show_parents', true);
        echo '<tr><td class="descriptionbox wrap width33">';
        echo WT_I18N::translate('Show Parents?');
        echo '</td><td class="optionbox">';
