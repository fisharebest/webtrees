...
class Administration extends BaseTheme {
	...
	protected function menuAdminSite() {
		return new WT_Menu(/* I18N: Menu entry*/ WT_I18N::translate('webtrees'), '#', '', '', array(
			new WT_Menu(/* I18N: Menu entry */ WT_I18N::translate('Site preferences'), 'admin_site_config.php?section=site'),
			new WT_Menu(/* I18N: Menu entry */ WT_I18N::translate('Sending email'), 'admin_site_config.php?section=email'),
			new WT_Menu(/* I18N: Menu entry */ WT_I18N::translate('Login and registration'), 'admin_site_config.php?section=login'),
	...
	protected function menuAdminUsers() {
		return new WT_Menu(/* I18N: Menu entry */ WT_I18N::translate('Users'), '#', '', '', array(
			...
			new WT_Menu(/* I18N: Menu entry */ WT_I18N::translate('Add a new user'), 'admin_users.php?action=createform'),
	...
	protected function menuAdminModules() {
		return new WT_Menu(/* I18N: Menu entry */ WT_I18N::translate('Modules'), '#', '', '', array(
			...
			new WT_Menu(/* I18N: Menu entry */ WT_I18N::translate('Sidebar'), 'admin_module_sidebar.php'),
