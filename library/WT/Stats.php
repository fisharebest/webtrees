...
///////////////////////////////////////////////////////////////////////////////
	...
	function chartIndisWithSources($params=null) {
		...
		if ($tot_indi==0) {
			...
			return "<img src=\"https://chart.apis.google.com/chart?cht=p3&amp;chd=e:{$chd}&amp;chs={$size}&amp;chco={$color_from},{$color_to}&amp;chf=bg,s,ffffff00&amp;chl={$chl}\" width=\"{$sizes[0]}\" height=\"{$sizes[1]}\" alt=\"".$chart_title."\" title=\"".$chart_title."\" />";
		}
	}
	...
	function chartSex($params=null) {
		...
		if ($tot==0) {
			...
			$chart_title =
				...
				WT_I18N::translate_c('unknown people', 'Unknown').' - '.$per_u;
			return "<img src=\"https://chart.apis.google.com/chart?cht=p3&amp;chd=e:{$chd}&amp;chs={$size}&amp;chco={$color_unknown},{$color_female},{$color_male}&amp;chf=bg,s,ffffff00&amp;chl={$chl}\" width=\"{$sizes[0]}\" height=\"{$sizes[1]}\" alt=\"".$chart_title."\" title=\"".$chart_title."\" />";
		} else {
			...
			$chart_title =  WT_I18N::translate('Males').' - '.$per_m.WT_I18N::$list_separator.
							WT_I18N::translate('Females').' - '.$per_f;
			return "<img src=\"https://chart.apis.google.com/chart?cht=p3&amp;chd=e:{$chd}&amp;chs={$size}&amp;chco={$color_female},{$color_male}&amp;chf=bg,s,ffffff00&amp;chl={$chl}\" width=\"{$sizes[0]}\" height=\"{$sizes[1]}\" alt=\"".$chart_title."\" title=\"".$chart_title."\" />";
		}
	}
	...
	function chartMortality($params=null) {
		...
		if ($tot==0) {
			...
			$chart_title =  WT_I18N::translate('Living').' - '.$per_l.WT_I18N::$list_separator.
							WT_I18N::translate('Dead').' - '.$per_d;
			return "<img src=\"https://chart.apis.google.com/chart?cht=p3&amp;chd=e:{$chd}&amp;chs={$size}&amp;chco={$color_living},{$color_dead}&amp;chf=bg,s,ffffff00&amp;chl={$chl}\" width=\"{$sizes[0]}\" height=\"{$sizes[1]}\" alt=\"".$chart_title."\" title=\"".$chart_title."\" />";
		}
	}
...
///////////////////////////////////////////////////////////////////////////////
	...
	function _statsBirth($simple=true, $sex=false, $year1=-1, $year2=-1, $params=null) {
		...
		if ($simple) {
			...
			return "<img src=\"https://chart.apis.google.com/chart?cht=p3&amp;chd=e:{$chd}&amp;chs={$size}&amp;chco={$color_from},{$color_to}&amp;chf=bg,s,ffffff00&amp;chl={$chl}\" width=\"{$sizes[0]}\" height=\"{$sizes[1]}\" alt=\"".WT_I18N::translate('Births by century')."\" title=\"".WT_I18N::translate('Births by century')."\" />";
		}
	...
	function _statsDeath($simple=true, $sex=false, $year1=-1, $year2=-1, $params=null) {
		...
		if ($simple) {
			...
			$chd = self::_array_to_extended_encoding($counts);
			$chl = rawurlencode(substr($centuries,0,-1));
			return "<img src=\"https://chart.apis.google.com/chart?cht=p3&amp;chd=e:{$chd}&amp;chs={$size}&amp;chco={$color_from},{$color_to}&amp;chf=bg,s,ffffff00&amp;chl={$chl}\" width=\"{$sizes[0]}\" height=\"{$sizes[1]}\" alt=\"".WT_I18N::translate('Deaths by century')."\" title=\"".WT_I18N::translate('Deaths by century')."\" />";
		}
		if (!isset($rows)) {return 0;}
		return $rows;
	}
	...
	*/
	...
	function _statsMarr($simple=true, $first=false, $year1=-1, $year2=-1, $params=null) {
		...
		if ($simple) {
			...
			return "<img src=\"https://chart.apis.google.com/chart?cht=p3&amp;chd=e:{$chd}&amp;chs={$size}&amp;chco={$color_from},{$color_to}&amp;chf=bg,s,ffffff00&amp;chl={$chl}\" width=\"{$sizes[0]}\" height=\"{$sizes[1]}\" alt=\"".WT_I18N::translate('Marriages by century')."\" title=\"".WT_I18N::translate('Marriages by century')."\" />";
		}
		return $rows;
	}
	...
	function _statsDiv($simple=true, $first=false, $year1=-1, $year2=-1, $params=null) {
		...
		if ($simple) {
			...
			$chd = self::_array_to_extended_encoding($counts);
			$chl = substr($centuries,0,-1);
			return "<img src=\"https://chart.apis.google.com/chart?cht=p3&amp;chd=e:{$chd}&amp;chs={$size}&amp;chco={$color_from},{$color_to}&amp;chf=bg,s,ffffff00&amp;chl={$chl}\" width=\"{$sizes[0]}\" height=\"{$sizes[1]}\" alt=\"".WT_I18N::translate('Divorces by century')."\" title=\"".WT_I18N::translate('Divorces by century')."\" />";
		}
		return $rows;
	}
...
///////////////////////////////////////////////////////////////////////////////
	...
	function _monthFirstChildQuery($simple=true, $sex=false, $year1=-1, $year2=-1, $params=null) {
		...
		if ($simple) {
			...
			$chd = self::_array_to_extended_encoding($counts);
			$chl = substr($text,0,-1);
			return '<img src="https://chart.apis.google.com/chart?cht=p3&amp;chd=e:'.$chd.'&amp;chs='.$size.'&amp;chco='.$color_from.','.$color_to.'&amp;chf=bg,s,ffffff00&amp;chl='.$chl.'" width="'.$sizes[0].'" height="'.$sizes[1].'" alt="'.WT_I18N::translate('Month of birth of first child in a relation').'" title="'.WT_I18N::translate('Month of birth of first child in a relation').'" />';
		}
		if (!isset($rows)) return 0;
		return $rows;
	}
	...
	function chartLargestFamilies($params=null) {
		...
		return "<img src=\"https://chart.apis.google.com/chart?cht=p3&amp;chd=e:{$chd}&amp;chs={$size}&amp;chco={$color_from},{$color_to}&amp;chf=bg,s,ffffff00&amp;chl={$chl}\" width=\"{$sizes[0]}\" height=\"{$sizes[1]}\" alt=\"".WT_I18N::translate('Largest families')."\" title=\"".WT_I18N::translate('Largest families')."\" />";
	}
...
///////////////////////////////////////////////////////////////////////////////
	...
	function chartCommonSurnames($params=null) {
		...
		$chl=implode('|', $chl);
		return '<img src="https://chart.apis.google.com/chart?cht=p3&amp;chd=e:'.$chd.'&amp;chs='.$size.'&amp;chco='.$color_from.','.$color_to.'&amp;chf=bg,s,ffffff00&amp;chl='.rawurlencode($chl).'" width="'.$sizes[0].'" height="'.$sizes[1].'" alt="'.$chart_title.'" title="'.$chart_title.'" />';
	}
