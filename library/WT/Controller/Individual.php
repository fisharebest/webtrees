...
class WT_Controller_Individual extends WT_Controller_GedcomRecord {
	...
	public function getSideBarContent() {
		...
		if ($html) {
			...
			return '<div id="sidebar"><script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script><!-- soyagaci_250x150 --><ins class="adsbygoogle" style="display:inline-block;width:250px;height:150px" data-ad-client="ca-pub-2761280977499172" data-ad-slot="6078819247"></ins><script>(adsbygoogle = window.adsbygoogle || []).push({}); </script><div id="sidebarAccordion">' . $html . '</div></div>';			
		} else {
			return '';
		}
	}
