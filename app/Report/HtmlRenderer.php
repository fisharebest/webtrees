...
class HtmlRenderer extends AbstractRenderer
{
    ...
    public function setup(): void
    {
        ...
        if ($this->show_generated_by) {
            ...
            $element = new HtmlCell(0.0, 10.0, '', 'C', '', $this->getStyle('genby'), 1, AbstractElement::CURRENT_POSITION, AbstractElement::CURRENT_POSITION, false, 0, '', '', true);
    ...
    public function createCell(float $width, float $height, string $border, string $align, string $bgcolor, Style $style, int $ln, float $top, float $left, bool $fill, int $stretch, string $bocolor, string $tcolor, bool $reseth): HtmlCell
    {
