...
class UTF8 extends AbstractEncoding
{
    ...
    public const string ARABIC_LETTER_MARK                                    = "\u{061C}";
    ...
    public const string ARABIC_PERCENT_SIGN                                   = "\u{066A}";
    public const string ARABIC_DECIMAL_SEPARATOR                              = "\u{066B}";
    public const string ARABIC_THOUSANDS_SEPARATOR                            = "\u{066C}";
    public const string ARABIC_INDIC_DIGIT_ZERO                               = "\u{0660}";
    public const string ARABIC_INDIC_DIGIT_ONE                                = "\u{0661}";
    public const string ARABIC_INDIC_DIGIT_TWO                                = "\u{0662}";
    public const string ARABIC_INDIC_DIGIT_THREE                              = "\u{0663}";
    public const string ARABIC_INDIC_DIGIT_FOUR                               = "\u{0664}";
    public const string ARABIC_INDIC_DIGIT_FIVE                               = "\u{0665}";
    public const string ARABIC_INDIC_DIGIT_SIX                                = "\u{0666}";
    public const string ARABIC_INDIC_DIGIT_SEVEN                              = "\u{0667}";
    public const string ARABIC_INDIC_DIGIT_EIGHT                              = "\u{0668}";
    public const string ARABIC_INDIC_DIGIT_NINE                               = "\u{0669}";
    public const string EXTENDED_ARABIC_INDIC_DIGIT_ZERO                      = "\u{06F0}";
    public const string EXTENDED_ARABIC_INDIC_DIGIT_ONE                       = "\u{06F1}";
    public const string EXTENDED_ARABIC_INDIC_DIGIT_TWO                       = "\u{06F2}";
    public const string EXTENDED_ARABIC_INDIC_DIGIT_THREE                     = "\u{06F3}";
    public const string EXTENDED_ARABIC_INDIC_DIGIT_FOUR                      = "\u{06F4}";
    public const string EXTENDED_ARABIC_INDIC_DIGIT_FIVE                      = "\u{06F5}";
    public const string EXTENDED_ARABIC_INDIC_DIGIT_SIX                       = "\u{06F6}";
    public const string EXTENDED_ARABIC_INDIC_DIGIT_SEVEN                     = "\u{06F7}";
    public const string EXTENDED_ARABIC_INDIC_DIGIT_EIGHT                     = "\u{06F8}";
    public const string EXTENDED_ARABIC_INDIC_DIGIT_NINE                      = "\u{06F9}";
    public const string DEVANAGARI_DIGIT_ZERO                                 = "\u{0966}";
    public const string DEVANAGARI_DIGIT_ONE                                  = "\u{0967}";
    public const string DEVANAGARI_DIGIT_TWO                                  = "\u{0968}";
    public const string DEVANAGARI_DIGIT_THREE                                = "\u{0969}";
    public const string DEVANAGARI_DIGIT_FOUR                                 = "\u{096A}";
    public const string DEVANAGARI_DIGIT_FIVE                                 = "\u{096B}";
    public const string DEVANAGARI_DIGIT_SIX                                  = "\u{096C}";
    public const string DEVANAGARI_DIGIT_SEVEN                                = "\u{096D}";
    public const string DEVANAGARI_DIGIT_EIGHT                                = "\u{096E}";
    public const string DEVANAGARI_DIGIT_NINE                                 = "\u{096F}";
    public const string TAMIL_DIGIT_ZERO                                      = "\u{0BE6}";
    public const string TAMIL_DIGIT_ONE                                       = "\u{0BE7}";
    public const string TAMIL_DIGIT_TWO                                       = "\u{0BE8}";
    public const string TAMIL_DIGIT_THREE                                     = "\u{0BE9}";
    public const string TAMIL_DIGIT_FOUR                                      = "\u{0BEA}";
    public const string TAMIL_DIGIT_FIVE                                      = "\u{0BEB}";
    public const string TAMIL_DIGIT_SIX                                       = "\u{0BEC}";
    public const string TAMIL_DIGIT_SEVEN                                     = "\u{0BED}";
    public const string TAMIL_DIGIT_EIGHT                                     = "\u{0BEE}";
    public const string TAMIL_DIGIT_NINE                                      = "\u{0BEF}";
    public const string THAI_DIGIT_ZERO                                       = "\u{0E50}";
    public const string THAI_DIGIT_ONE                                        = "\u{0E51}";
    public const string THAI_DIGIT_TWO                                        = "\u{0E52}";
    public const string THAI_DIGIT_THREE                                      = "\u{0E53}";
    public const string THAI_DIGIT_FOUR                                       = "\u{0E54}";
    public const string THAI_DIGIT_FIVE                                       = "\u{0E55}";
    public const string THAI_DIGIT_SIX                                        = "\u{0E56}";
    public const string THAI_DIGIT_SEVEN                                      = "\u{0E57}";
    public const string THAI_DIGIT_EIGHT                                      = "\u{0E58}";
    public const string THAI_DIGIT_NINE                                       = "\u{0E59}";
    public const string SUNDANESE_DIGIT_ZERO                                  = "\u{1BB0}";
    public const string SUNDANESE_DIGIT_ONE                                   = "\u{1BB1}";
    public const string SUNDANESE_DIGIT_TWO                                   = "\u{1BB2}";
    public const string SUNDANESE_DIGIT_THREE                                 = "\u{1BB3}";
    public const string SUNDANESE_DIGIT_FOUR                                  = "\u{1BB4}";
    public const string SUNDANESE_DIGIT_FIVE                                  = "\u{1BB5}";
    public const string SUNDANESE_DIGIT_SIX                                   = "\u{1BB6}";
    ...
    public const string MINUS_SIGN                                            = "\u{2212}";
    ...
    public const string JAVANESE_DIGIT_ZERO                                   = "\u{A9D0}";
    public const string JAVANESE_DIGIT_ONE                                    = "\u{A9D1}";
    public const string JAVANESE_DIGIT_TWO                                    = "\u{A9D2}";
    public const string JAVANESE_DIGIT_THREE                                  = "\u{A9D3}";
    public const string JAVANESE_DIGIT_FOUR                                   = "\u{A9D4}";
    public const string JAVANESE_DIGIT_FIVE                                   = "\u{A9D5}";
    public const string JAVANESE_DIGIT_SIX                                    = "\u{A9D6}";
    public const string JAVANESE_DIGIT_SEVEN                                  = "\u{A9D7}";
    public const string JAVANESE_DIGIT_EIGHT                                  = "\u{A9D8}";
    public const string JAVANESE_DIGIT_NINE                                   = "\u{A9D9}";
