...
class UserMessagesModule extends AbstractModule implements ModuleBlockInterface {
	...
	public function getBlock($block_id, $template = true, $cfg = []) {
		...
		if ($messages) {
			...
			$content .= '<th class="list_label">' . I18N::translate('Delete') . '<br><a href="#" onclick="$(\'#block-' . $block_id . ' :checkbox\').prop(\'checked\', function (i, val) { return !val; }); return false;">' . I18N::translate('All') . '</a></th>';
