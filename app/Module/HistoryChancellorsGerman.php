...
class HistoryChancellorsGerman extends AbstractModule implements ModuleHistoricEventsInterface
{
    ...
    {
        /**
        * Variables used for TYPE.
        *
        * @return string
        */
        $eventTypeA  = I18N::translate('Imperial Chancellor');                                          // Reichskanzler
        $eventTypeB  = I18N::translate('Chairman of the Revolutionary Council of Peoples Deputies');    // Vorsitzenden des revolutionären Rats der Volksbeauftragten
        $eventTypeC  = I18N::translate('Leader and Imperial chancellor');                               // Führer und Reichskanzler
        $eventTypeD  = I18N::translate('Occupation Force');                                             // Besatzungsmacht
        $eventTypeEm = I18N::translate('Chancellor');                                                   // Bundeskanzler
        $eventTypeEf = I18N::translate('Chancellor');                                                   // Bundeskanzlerin
        $eventTypeF  = I18N::translate('Acting Chancellor');                                            // Geschäftsführender Bundeskanzler
        $eventTypeG  = I18N::translate('President of the Republic');                                    // Präsident der Republik
        $eventTypeH  = I18N::translate('Chairman of the Council of State');                             // Vorsitzender des Staatsrats
