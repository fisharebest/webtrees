...
class NewZealandPrimeMinisters extends AbstractModule implements ModuleHistoricEventsInterface
{
    ...
    {
        return 'New Zealand - Nu Tirani Premiers / Prime Ministers';
    }
        ...
        switch (I18N::languageTag()) {
            ...
            case 'en-US':
                return new Collection([
                    "1 EVEN Henry Sewell\n2 TYPE Premier of New Zealand - Nu Tirani\n2 DATE FROM 07 MAY 1856 TO 20 MAY 1856",
                    ...
                    "1 EVEN Richard Seddon, Last \n2 TYPE Premier of New Zealand - Nu Tirani\n2 DATE FROM 01 MAY 1893 TO 10 JUN 1906",
                    "1 EVEN William Hall-Jones, Liberal Party, NZ's First PM\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 21 JUN 1906 TO 06 AUG 1906",
                    "1 EVEN Sir Joseph Ward, Liberal; United Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 06 AUG 1906 TO 12 MAR 1912",
                    "1 EVEN Thomas Mackenzie, Liberal Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 28 MAR 1912 TO 10 JUL 1912",
                    "1 EVEN William Massey, Reform Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 10 JUL 1912 TO 10 MAY 1925",
                    "1 EVEN Sir Francis Henry Dillon Bell, Reform Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 14 MAY 1925 TO 30 MAY 1925",
                    "1 EVEN Gordon Coates, Reform Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 30 MAY 1925 TO 10 DEC 1928",
                    "1 EVEN George Forbes, United; Coalition Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 10 DEC 1928 TO 28 MAY 1930",
                    "1 EVEN Sir Joseph Ward, Liberal; United Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 28 MAY 1930 TO 06 DEC 1935",
                    "1 EVEN Michael Joseph Savage, First Labour Party PM\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 06 DEC 1935 TO 27 MAR 1940",
                    "1 EVEN Peter Fraser, Labour Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 27 MAR 1940 TO 13 DEC 1949",
                    "1 EVEN Sidney Holland, National\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 13 DEC 1949 TO 20 SEP 1957",
                    "1 EVEN Keith Holyoake, National Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 20 SEP 1957 TO 12 DEC 1957",
                    "1 EVEN Walter Nash, Labour Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 12 DEC 1957 TO 12 DEC 1960",
                    "1 EVEN Keith Holyoake\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 12 DEC 1960 TO 07 FEB 1972",
                    "1 EVEN John 'Jack' Marshall, National Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 07 FEB 1972 TO 08 DEC 1972",
                    "1 EVEN Norman Kirk, Affectionately known as 'Big Norm'. Labour Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 08 DEC 1972 TO 31 AUG 1974",
                    "1 EVEN Wallace Edward 'Bill' Rowling, Labour Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 06 SEP 1974 TO 12 DEC 1975",
                    "1 EVEN Robert David 'Rob' Muldoon, National Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 12 DEC 1975 TO 26 JUL 1984",
                    "1 EVEN David Russell Lange, Labour Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 26 JUL 1984 TO 08 AUG 1989",
                    "1 EVEN Geoffrey Winston Palmer, Labour Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 08 AUG 1989 TO 04 SEP 1990",
                    "1 EVEN Michael Kenneth 'Mike' Moore, Labour Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 04 SEP 1990 TO 02 NOV 1990",
                    "1 EVEN James Brendan 'Jim' Bolger, National Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 02 NOV 1990 TO 08 DEC 1997",
                    "1 EVEN Jennifer Mary 'Jenny' Shipley, National Party, NZ's First Female PM\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 08 DEC 1997 TO 05 DEC 1999",
                    "1 EVEN Helen Clark, Labour Party, NZ's First Elected Female PM\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 05 DEC 1999 TO 19 NOV 2008",
                    "1 EVEN John Key, National Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 19 NOV 2008 TO 12 DEC 2016",
                    "1 EVEN Simon William 'Bill' English, National Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 12 DEC 2016 TO 26 OCT 2017",
                    "1 EVEN Jacinda Ardern, Labour Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 26 OCT 2017 TO 25 JAN 2023",
                    "1 EVEN Christopher John 'Chris' Hipkins, Labour Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 25 JAN 2023 TO 14 OCT 2023",
                    "1 EVEN Christopher 'Chris' Luxon, National Party\n2 TYPE Prime Minister of New Zealand - Nu Tirani\n2 DATE FROM 14 OCT 2023",
                ]);
