...
abstract class AbstractIndividualListModule extends AbstractModule implements ModuleListInterface, RequestHandlerInterface
{
    ...
    abstract protected function showFamilies(): bool;

    abstract protected function routeUrl(): string;
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $surname_data     = $this->surnameData($tree, $show_marnm === 'yes', $this->showFamilies());
