...
class WebtreesSchema
{
    ...
    public static function tableBlock(): Table
    {
        return Table::editor()
            ...
            ->addColumn(column: DB::varchar(name: 'location', length: 4, nullable: true))
    ...
    public static function tableChange(): Table
    {
        return Table::editor()
            ...
            ->addColumn(column: DB::varchar(name: 'status', length: 8))
    ...
    public static function tableDates(): Table
    {
        return Table::editor()
            ...
            ->addColumn(column: DB::varchar(name: 'd_month', length: 5))
    ...
    public static function tableFavorite(): Table
    {
        return Table::editor()
            ...
            ->addColumn(column: DB::integer(name: 'gedcom_id'))
            ->addColumn(column: DB::varchar(name: 'xref', length: 20, nullable: true))
            ->addColumn(column: DB::varchar(name: 'favorite_type', length: 4))
    ...
    public static function tableIndividuals(): Table
    {
        return Table::editor()
            ...
            ->addColumn(column: DB::varchar(name: 'i_sex', length: 1))
    ...
    public static function tableModule(): Table
    {
        return Table::editor()
            ...
            ->addColumn(column: DB::varchar(name: 'module_name', length: 32))
            ->addColumn(column: DB::varchar(name: 'status', length: 8, default: 'enabled'))
