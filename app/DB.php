...
final class DB extends Manager
{
    ...
    // MySQL 8 uses utf8mb4_0900_ai_ci (i.e. Unicode 9.0) for utf8mb4
    // MySQL 9 uses utf8mb4_uca1400_ai_ci (i.e. Unicode 14.0) for utf8mb4
    ...
    public static function nchar(string $name, int $length, bool $nullable = false, string|null $default = null): Column
    {
        return Column::editor()
            ...
            ->setNotNull(!$nullable)
            ->setDefaultValue($default)
            ->setCharset(self::CHARSET_UTF8[self::driverName()])
