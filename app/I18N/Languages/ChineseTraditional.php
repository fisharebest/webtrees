...
final readonly class ChineseTraditional extends AbstractLanguage
{
    ...
    public function relationships(): array
    {
        ...
        return [
            ...
            Relationship::fixed(...$zh('雙胞胎姐姐'))->multiple()->older()->sister(),
            Relationship::fixed(...$zh('雙胞胎妹妹'))->multiple()->younger()->sister(),
            Relationship::fixed(...$zh('雙胞胎哥哥'))->multiple()->older()->brother(),
            Relationship::fixed(...$zh('雙胞胎弟弟'))->multiple()->younger()->brother(),
            Relationship::fixed(...$zh('雙胞胎'))->multiple()->sibling(),
