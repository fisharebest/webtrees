...
final readonly class EnglishAustralia extends AbstractEnglish
{
    protected const string    ENDONYM      = 'Australian English';
    protected const PaperSize PAPER_SIZE   = PaperSize::A4;
    protected const string    LANGUAGE_TAG = 'en-AU';
    protected const string    LOCALE_CODE  = 'en_AU@collation=phonebook';
