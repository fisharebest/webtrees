...
final readonly class EnglishGreatBritain extends AbstractEnglish
{
    protected const string    ENDONYM      = 'British English';
    protected const PaperSize PAPER_SIZE   = PaperSize::A4;
    protected const string    LANGUAGE_TAG = 'en-GB';
    protected const string    LOCALE_CODE  = 'en_GB@collation=phonebook';
