...
final readonly class Croatian extends AbstractLanguage
{
    ...
    public function relationships(): array
    {
        ...
        return [
            ...
            Relationship::fixed(...$rel('zaručnica', 'zaručnice'))->engaged()->partner()->female(),
            Relationship::fixed(...$rel('zaručnik', 'zaručnika'))->engaged()->partner()->male(),
            ...
            Relationship::fixed(...$rel('šurjak', 'šurjaka'))->sibling()->husband(),
            // Grandparents
            Relationship::fixed(...$rel('baka', 'bake'))->parent()->mother(),
            Relationship::fixed(...$rel('djed', 'djeda'))->parent()->father(),
            Relationship::fixed(...$rel('baka/djed', 'bake/djeda'))->parent()->parent(),
            // Grandchildren
            ...
            Relationship::dynamic(static fn (int $n) => $pra($n - 2, 'djed', 'djeda'))->ancestor()->male(),
            Relationship::dynamic(static fn (int $n) => $pra($n - 2, 'baka/djed', 'bake/djeda'))->ancestor(),
