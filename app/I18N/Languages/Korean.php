...
final readonly class Korean extends AbstractLanguage
{
    ...
    public function relationships(): array
    {
        ...
        return [
            ...
            Relationship::fixed(...$ko('쌍둥이 언니'))->multiple()->selfFemale()->older()->sister(),
            Relationship::fixed(...$ko('쌍둥이 누나'))->multiple()->older()->sister(),
            Relationship::fixed(...$ko('쌍둥이 여동생'))->multiple()->younger()->sister(),
            Relationship::fixed(...$ko('쌍둥이 오빠'))->multiple()->selfFemale()->older()->brother(),
            Relationship::fixed(...$ko('쌍둥이 형'))->multiple()->older()->brother(),
            Relationship::fixed(...$ko('쌍둥이 남동생'))->multiple()->younger()->brother(),
            Relationship::fixed(...$ko('쌍둥이'))->multiple()->sibling(),
