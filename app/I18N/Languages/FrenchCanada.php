...
final readonly class FrenchCanada extends AbstractFrench
{
    protected const string    ENDONYM        = 'français canadien';
    ...
    protected const string DATE_FROM = 'à partir de %s';
    protected const string DATE_TO   = 'vers %s';
    protected const string ERA_BCE   = '%s' . UTF8::NO_BREAK_SPACE . 'Avant cette ère';
    protected const string ERA_CE    = '%s' . UTF8::NO_BREAK_SPACE . 'De cette ère';
