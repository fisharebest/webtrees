...
final readonly class CensusColumnConditionFrenchHomme extends AbstractCensusColumnCondition
{
    protected const string HUSBAND = '1';
    ...
    protected const string DIVORCE = '1';
