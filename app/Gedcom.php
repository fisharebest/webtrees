...
class Gedcom
{
    ...
    private function gedcom551Tags(): array
    {
        return [
            ...
            'FAM:*:PLAC:NOTE'            => new NoteStructure(I18N::translate('Note on the place')),
            ...
            'FAM:*:SOUR:NOTE'            => new NoteStructure(I18N::translate('Note on the source citation')),
            ...
            'FAM:CHAN:NOTE'              => new NoteStructure(I18N::translate('Note on the last change')),
            ...
            'INDI:*:PLAC:NOTE'           => new NoteStructure(I18N::translate('Note on the place')),
            ...
            'INDI:*:SOUR:NOTE'           => new NoteStructure(I18N::translate('Note on the source citation')),
            ...
            'INDI:CHAN:NOTE'             => new NoteStructure(I18N::translate('Note on the last change')),
            ...
            'INDI:NAME:*:SOUR:NOTE'      => new NoteStructure(I18N::translate('Note on the source citation')),
            ...
            'INDI:NAME:FONE:NOTE'        => new NoteStructure(I18N::translate('Note on the phonetic name')),
            ...
            'INDI:NAME:ROMN:NOTE'        => new NoteStructure(I18N::translate('Note on the romanized name')),
            ...
            'NOTE:CHAN:NOTE'             => new NoteStructure(I18N::translate('Note on the last change')),
            ...
            'NOTE:SOUR:NOTE'             => new NoteStructure(I18N::translate('Note on the source citation')),
            ...
            'OBJE:CHAN:NOTE'             => new NoteStructure(I18N::translate('Note on the last change')),
            ...
            'OBJE:SOUR:NOTE'             => new NoteStructure(I18N::translate('Note on the source citation')),
            ...
            'REPO:CHAN:NOTE'             => new NoteStructure(I18N::translate('Note on the last change')),
            ...
            'SOUR:CHAN:NOTE'             => new NoteStructure(I18N::translate('Note on the last change')),
            ...
            'SOUR:DATA:NOTE'             => new NoteStructure(I18N::translate('Note on the source data')),
            'SOUR:NOTE'                  => new NoteStructure(I18N::translate('Note on the source')),
            ...
            'SOUR:REPO:NOTE'             => new NoteStructure(I18N::translate('Note on the repository reference')),
            ...
            'SUBM:CHAN:NOTE'             => new NoteStructure(I18N::translate('Note on the last change')),
            ...
            'SUBN:CHAN:NOTE'             => new NoteStructure(I18N::translate('Note on the last change')),
    ...
    private function gedcomLTags(): array
    {
        return [
            ...
            'FAM:*:_ASSO:NOTE'                => new NoteStructure(I18N::translate('Note on the association')),
            ...
            'FAM:*:_ASSO:SOUR:NOTE'           => new NoteStructure(I18N::translate('Note on the source citation')),
            ...
            'INDI:*:_ASSO:NOTE'               => new NoteStructure(I18N::translate('Note on the association')),
            ...
            'INDI:*:_ASSO:SOUR:NOTE'          => new NoteStructure(I18N::translate('Note on the source citation')),
            ...
            '_LOC:CHAN:NOTE'                  => new NoteStructure(I18N::translate('Note on the last change')),
            ...
            '_LOC:EVEN:PLAC:NOTE'             => new NoteStructure(I18N::translate('Note on the place')),
            ...
            '_LOC:SOUR:NOTE'                  => new NoteStructure(I18N::translate('Note on the source citation')),
