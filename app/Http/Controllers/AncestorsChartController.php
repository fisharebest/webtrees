 ...
 */
class AncestorsChartController extends AbstractBaseController
{
    // Chart styles
    ...
    // Defaults
    private const DEFAULT_COUSINS             = false;
    ...
    public function page(Request $request, Tree $tree): Response
    {
        ...
        if ($individual !== null && $individual->canShowName()) {
            ...
            $title = I18N::translate('Ancestors of %s', $individual->getFullName());
        } else {
