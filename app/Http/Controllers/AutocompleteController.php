...
class AutocompleteController extends AbstractBaseController
{
     ...
     * @return JsonResponse
     */
    public function folder(ServerRequestInterface $request, Tree $tree, Filesystem $filesystem): JsonResponse
    {
     ...
     * @return JsonResponse
     */
    public function page(ServerRequestInterface $request, Tree $tree): JsonResponse
    {
        $query = $request->get('query', '');
     ...
     * @return JsonResponse
     */
    public function place(ServerRequestInterface $request, Tree $tree): JsonResponse
    {
        $query = $request->get('query', '');
        $data  = [];
     ...
     * @return JsonResponse
     */
    public function select2Family(ServerRequestInterface $request, Tree $tree): JsonResponse
    {
     ...
     * @return JsonResponse
     */
    public function select2Individual(ServerRequestInterface $request, Tree $tree): JsonResponse
    {
        $page  = (int) $request->get('page');
        $query = $request->get('q', '');
     ...
     * @return JsonResponse
     */
    public function select2MediaObject(ServerRequestInterface $request, Tree $tree): JsonResponse
    {
        $page  = (int) $request->get('page');
        $query = $request->get('q', '');
     ...
     * @return JsonResponse
     */
    public function select2Note(ServerRequestInterface $request, Tree $tree): JsonResponse
    {
        $page  = (int) $request->get('page');
        $query = $request->get('q', '');
     ...
     * @return JsonResponse
     */
    public function select2Place(ServerRequestInterface $request, Tree $tree): JsonResponse
    {
        $page  = (int) $request->get('page');
        $query = $request->get('q', '');
     ...
     * @return JsonResponse
     */
    public function select2Repository(ServerRequestInterface $request, Tree $tree): JsonResponse
    {
        $page  = (int) $request->get('page');
        $query = $request->get('q', '');
     ...
     * @return JsonResponse
     */
    public function select2Source(ServerRequestInterface $request, Tree $tree): JsonResponse
    {
        $page  = (int) $request->get('page');
        $query = $request->get('q', '');
     ...
     * @return JsonResponse
     */
    public function select2Submitter(ServerRequestInterface $request, Tree $tree): JsonResponse
    {
        $page  = (int) $request->get('page');
        $query = $request->get('q', '');
