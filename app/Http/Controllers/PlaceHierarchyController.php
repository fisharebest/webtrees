	...
	public function show(Request $request): Response {
		...
		switch ($action) {
			case 'list':
				...
				$content         .= view('modules/openstreetmap/place-list', $this->getList($tree));
				break;
			case 'hierarchy':
			case 'hierarchy-e':
				$nextaction      = 'list';
				...
				$content         .= (null === $data) ? '' : view('modules/openstreetmap/place-hierarchy', $data);
				if (null === $data || $action === 'hierarchy-e') {
					$content .= view('modules/openstreetmap/place-events', $this->getEvents($tree, $place));
				}
				break;
			default:
				$nextaction      = '';
		...
		return $this->viewResponse(
			'modules/openstreetmap/places-page',
			[
