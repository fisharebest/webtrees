...
use Fisharebest\Webtrees\Http\RequestHandlers\GazetteerAction;
use Fisharebest\Webtrees\Http\RequestHandlers\GazetteerPage;
...
use Fisharebest\Webtrees\Http\RequestHandlers\MapProviderImportAction;
    ...
    public function load(Map $router): void
    {
        $router->attach('', '', static function (Map $router) {
            ...
            $router->attach('', '/admin', static function (Map $router) {
                ...
                $router->post(GazetteerAction::class, '/gazetteer');
                $router->get(GazetteerPage::class, '/gazetteer');
                ...
                $router->post(MapProviderDelete::class, '/map-provider-delete/{provider}');
                $router->get(MapProviderImportPage::class, '/map-provider-import');
                $router->post(MapProviderImportAction::class, '/map-provider-import');
                $router->post(MapProviderUpdateStyles::class, '/map-provider-styles-update');
