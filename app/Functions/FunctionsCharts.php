...
class FunctionsCharts
{
    ...
    public static function printFamilyParents(Family $family, int $sosa = 0, string $daboville = '', string $parid = '', string $gparid = ''): void
    {
        ...
        echo view('chart-box', ['individual' => $husb]);
        echo '</td></tr></table>';
        echo '</td>';
        // husband’s parents
        ...
        if ($hfam instanceof Family) {
            ...
            if ($hfam->husband() instanceof Individual) {
                ...
                echo '<td>';
                echo view('chart-box', ['individual' => $hfam->husband()]);
                echo '</td></tr></table>';
            } else {
                // Empty box for grandfather
                echo '<table cellspacing="0" cellpadding="0" border="0"><tr>';
                echo '<td>';
                echo view('chart-box', ['individual' => null]);
                echo '</td></tr></table>';
            }
            echo '</td>';
            if ($sosa !== -1) {
            ...
            if ($hfam->wife() instanceof Individual) {
                ...
                echo '<td>';
                echo view('chart-box', ['individual' => $hfam->wife()]);
                echo '</td></tr></table>';
            } else {
        ...
        echo view('chart-box', ['individual' => $wife]);
        echo '</td></tr></table>';
        echo '</td>';
        // wife’s parents
        ...
        if ($wfam instanceof Family) {
            ...
            if ($wfam->husband() instanceof Individual) {
                ...
                echo '<td>';
                echo view('chart-box', ['individual' => $wfam->husband()]);
                echo '</td></tr></table>';
            } else {
                // Empty box for grandfather
                echo '<table cellspacing="0" cellpadding="0" border="0"><tr>';
            ...
            if ($wfam->wife() instanceof Individual) {
                ...
                echo '<td>';
                echo view('chart-box', ['individual' => $wfam->wife()]);
                echo '</td></tr></table>';
            } else {
                // Empty box for grandmother
                echo '<table cellspacing="0" cellpadding="0" border="0"><tr>';
    ...
    public static function printFamilyChildren(
        ...
        if ($children->isNotEmpty()) {
            foreach ($children as $child) {
                ...
                echo view('chart-box', ['individual' => $child]);
                echo '</td>';
                if ($sosa !== 0) {
    ...
    private static function printCousins(Family $family): void
    {
        ...
        if ($fchildren->isNotEmpty()) {
            ...
            foreach ($fchildren as $fchil) {
                ...
                echo view('chart-box', ['individual' => $fchil]);
                echo '</td></tr>';
                if ($i < $ctkids) {
                    echo '<tr>';
                    $i++;
