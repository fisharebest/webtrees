...
use Fisharebest\Webtrees\Module\HistoryPresidentsGerman;
...
class ModuleService
{
    ...
    private const CORE_MODULES = [
        ...
        'history_chancellors_german' => HistoryChancellorsGerman::class,
        'history_presidents_german'  => HistoryPresidentsGerman::class,
