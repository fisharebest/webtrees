		...
		if (WT_USER_CAN_ACCEPT) {
			echo
				...
				/* I18N: %1$s is "accept", %2$s is "reject".  These are links. */ WT_I18N::translate(
					...
					'<a href="' . $controller->mediaobject->getHtmlUrl() . '&amp;action=accept">' . WT_I18N::translate_c('You should accept or reject it.', 'accept') . '</a>',
					'<a href="' . $controller->mediaobject->getHtmlUrl() . '&amp;action=undo">' . WT_I18N::translate_c('You should accept or reject it.', 'reject') . '</a>'
				),
