 ...
 */
class CensusOfMecklenburgSchwerin1919 extends CensusOfMecklenburgSchwerin implements CensusInterface {
	/**
	...
	public function columns() {
		return array(
			...
			new CensusColumnNull($this, 'Staatsangehörigkeit', 'Staatsangehörigkeit'),
