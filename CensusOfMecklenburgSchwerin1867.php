 ...
 */
class CensusOfMecklenburgSchwerin1867 extends CensusOfMecklenburgSchwerin implements CensusInterface {
	/**
	...
	public function columns() {
		return array(
			new CensusColumnNull($this, '1. Nummer', 'Ordnungs-Nummer (1-15).'),
			...
			new CensusColumnRelationToHead($this, '12. Bezug', 'V. Familienstand. Verhältnis der Familienglieder zum Haushaltungsvorstand.'),
			new CensusColumnOccupation($this, '13. Stand/Beruf', 'VI. Stand, Beruf oder Vorbereitung zum Beruf, Arbeits- und Dienstverhältnis.'),
			new CensusColumnNull($this, '14.', 'VII. Staatsangehörigkeit. Mecklenburg-Schwerinscher Unterthan.'),
			new CensusColumnNull($this, '15.', 'VII. Staatsangehörigkeit. Anderen Staaten angehörig. Welchem Staat?'),
