...
case 'scrollbars':
	...
	$text.='</dt><dd>';
	$text.=i18n::translate('If set to "no" the block will expand vertically to display the full list. If set to "yes" the block will be use scroll bars to view long lists.');
	$text.='</dd></dl>';
	break;
