 ...
 */
class CensusOfMecklenburgSchwerinNL1867 extends CensusOfMecklenburgSchwerin implements CensusInterface {
	/**
	...
	public function censusPlace() {
		return 'Mecklenburg-Schwerin Nachtragsliste';
	}	
	...
	public function columns() {
		return array(
			new CensusColumnNull($this, '1. Nummer', 'Ordnungs-Nummer.'),
			...
			new CensusColumnNull($this, '12.', 'VI. Staatsangehörigkeit. Mecklenburg-Schwerinscher Unterthan.'),
			new CensusColumnNull($this, '13.', 'VI. Staatsangehörigkeit. Anderen Staaten angehörig. Welchem Staat?'),
