...
echo
	'<p class="center"><input TYPE="button" VALUE="', WT_I18N::translate('Return to Administration page'), '" onclick="javascript:window.location=\'admin.php\'" /></p>',
	'<h2 class="center">', WT_I18N::translate('Site configuration'), '</h2>',
	...
	'<td class="facts_label" colspan="2">', WT_I18N::translate('Server configuration'), '</td>',
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Data file directory'), help_link('INDEX_DIRECTORY'), '</td>',
	'<td class="optionbox wrap"><input type="text" name="data_directory" value="', get_site_setting('INDEX_DIRECTORY'), '" size="50" /></td>',
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Memory limit'), help_link('MEMORY_LIMIT'), '</td>',
	'<td class="optionbox wrap"><input type="text" name="memory_limit" value="', get_site_setting('MEMORY_LIMIT'), '" /></td>',
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('PHP time limit'), help_link('MAX_EXECUTION_TIME'), '</td>',
	'<td class="optionbox wrap"><input type="text" name="max_execution_time" value="', get_site_setting('MAX_EXECUTION_TIME'), '" /></td>',
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Allow messages to be stored online'), help_link('STORE_MESSAGES'), '</td>',
	'<td class="optionbox wrap">', edit_field_yes_no('store_messages', get_site_setting('STORE_MESSAGES')), '</td>',
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Allow visitors to request account registration'), help_link('USE_REGISTRATION_MODULE'), '</td>',
	'<td class="optionbox wrap">', edit_field_yes_no('use_registration_module', get_site_setting('USE_REGISTRATION_MODULE')), '</td>',
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Require an administrator to approve new user registrations'), help_link('REQUIRE_ADMIN_AUTH_REGISTRATION'), '</td>',
	...
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Allow users to select their own theme'), help_link('ALLOW_USER_THEMES'), '</td>',
	'<td class="optionbox wrap">', edit_field_yes_no('allow_user_themes', get_site_setting('ALLOW_USER_THEMES')), '</td>',
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Default Theme'), help_link('THEME'), '</td>',
	'<td class="optionbox wrap">', select_edit_control('theme_dir', array_flip(get_theme_names()), null, get_site_setting('THEME_DIR', 'themes/webtrees/')),
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Allow GEDCOM switching'), help_link('ALLOW_CHANGE_GEDCOM'), '</td>',
	'<td class="optionbox wrap">', edit_field_yes_no('allow_change_gedcom', get_site_setting('ALLOW_CHANGE_GEDCOM')), '</td>',
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Session timeout'), help_link('SESSION_TIME'), '</td>',
	'<td class="optionbox wrap"><input type="text" name="session_time" value="', get_site_setting('SESSION_TIME'), '" /></td>',
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Website URL'), help_link('SERVER_URL'), '</td>',
	'<td class="optionbox wrap"><input type="text" name="server_url" value="', get_site_setting('SERVER_URL'), '" size="50" /></td>',
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Login URL'), help_link('LOGIN_URL'), '</td>',
	'<td class="optionbox wrap"><input type="text" name="login_url" value="', get_site_setting('LOGIN_URL'), '" size="50" /></td>',
	'</tr><tr>',
	'<td class="facts_label" colspan="2">', WT_I18N::translate('SMTP mail configuration'), '</td>',
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Messages'), help_link('SMTP_ACTIVE'), '</td>',
	...
	select_edit_control(
		...
		array(
			...
			'disabled'=>WT_I18N::translate('Do not send messages')
		),
		null,
		$smtp_active,
	...
	'</td>',
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Server'), help_link('SMTP_HOST'), '</td>',
	'<td class="optionbox wrap"><input type="text" name="smtp_host" value="', get_site_setting('SMTP_HOST'), '" ', $smtp_active=='external' ? '' : 'disabled', '/></td>',
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Port'), help_link('SMTP_PORT'), '</td>',
	'<td class="optionbox wrap"><input type="text" name="smtp_port" value="', get_site_setting('SMTP_PORT'), '" ', $smtp_active=='external' ? '' : 'disabled', '/></td>',
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Use simple mail headers'), help_link('SMTP_SIMPLE_MAIL'), '</td>',
	...
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Use password'), help_link('SMTP_AUTH'), '</td>',
	'<td class="optionbox wrap">', edit_field_yes_no('smtp_auth', get_site_setting('SMTP_AUTH'), $smtp_active=='external' ? '' : 'disabled'), '</td>',
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Username'), help_link('SMTP_AUTH_USER'), '</td>',
	...
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Password'), help_link('SMTP_AUTH_PASS'), '</td>',
	...
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Security'), help_link('SMTP_SSL'), '</td>',
	'<td class="optionbox wrap">',
	select_edit_control(
		'smtp_ssl',
		array(
			'none'=>WT_I18N::translate('none'),
			'ssl'=>WT_I18N::translate('ssl'),
			'tls'=>WT_I18N::translate('tls')
		),
		null,
	...
	'</td>',
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('From email address'), help_link('SMTP_FROM_NAME'), '</td>',
	...
	'</tr><tr>',
	'<td class="descriptionbox width20 wrap">', WT_I18N::translate('Sender email address'), help_link('SMTP_HELO'), '</td>',
	...
	'</tr><tr>',
	'<td class="topbottombar" colspan="2"><input type="submit" value="', WT_I18N::translate('Save'), '" /></td>',
	'</tr></table></form>';
