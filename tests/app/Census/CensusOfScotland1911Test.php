 ...
 */
class CensusOfScotland1911Test extends \Fisharebest\Webtrees\TestCase
{
    /**
    ...
    public function testColumns(): void
    {
        ...
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnConditionEnglish::class, $columns[5]);
        ...
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnChildrenDied::class, $columns[9]);
        ...
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnNationality::class, $columns[15]);
