 ...
 */
class CensusOfUnitedStates1900Test extends \Fisharebest\Webtrees\TestCase
{
    /**
    ...
    public function testColumns(): void
    {
        ...
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnSexMF::class, $columns[3]);
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnBirthMonth::class, $columns[4]);
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnBirthYear::class, $columns[5]);
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnAge::class, $columns[6]);
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnConditionUs::class, $columns[7]);
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnYearsMarried::class, $columns[8]);
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnChildrenBornAlive::class, $columns[9]);
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnChildrenLiving::class, $columns[10]);
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnBirthPlaceSimple::class, $columns[11]);
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnFatherBirthPlaceSimple::class, $columns[12]);
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnMotherBirthPlaceSimple::class, $columns[13]);
        ...
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnOccupation::class, $columns[17]);
