...
/**
 * Test harness for the class CensusColumnConditionFrench
 */
class CensusColumnConditionFrenchTest extends \PHPUnit_Framework_TestCase {
	/**
	 * Delete mock objects
	 */
	...
	/**
	 * @covers Fisharebest\Webtrees\Census\CensusColumnConditionFrench
	...
	public function testNoSpouseFamilies() {
		...
		$column = new CensusColumnConditionFrench($census, '', '');

		$this->assertSame('Célibataire', $column->generate($individual));
	}
	...
	public function testNoFamilyNoFacts() {
		...
		$this->assertSame('Marié', $column->generate($individual));
	}
	...
	public function testNoFamilyDivorced() {
		...
		$this->assertSame('Divorcé', $column->generate($individual));
	}
}
