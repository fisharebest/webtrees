 ...
 */
class CensusOfUnitedStates1940Test extends \Fisharebest\Webtrees\TestCase
{
    /**
    ...
    public function testColumns(): void
    {
        ...
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnAge::class, $columns[7]);
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnConditionUs::class, $columns[8]);
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnAgeMarried::class, $columns[9]);
        ...
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnBirthPlaceSimple::class, $columns[12]);
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnFatherBirthPlaceSimple::class, $columns[13]);
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnMotherBirthPlaceSimple::class, $columns[14]);
        ...
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnOccupation::class, $columns[19]);
