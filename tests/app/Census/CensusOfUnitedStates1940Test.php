...
class CensusOfUnitedStates1940Test extends TestCase
{
    ...
    public function testColumns(): void
    {
        ...
        $this->assertInstanceOf(CensusColumnAge::class, $columns[7]);
        $this->assertInstanceOf(CensusColumnConditionUs::class, $columns[8]);
        $this->assertInstanceOf(CensusColumnAgeMarried::class, $columns[9]);
        $this->assertInstanceOf(CensusColumnNull::class, $columns[10]);
        $this->assertInstanceOf(CensusColumnNull::class, $columns[11]);
        $this->assertInstanceOf(CensusColumnBirthPlaceSimple::class, $columns[12]);
        $this->assertInstanceOf(CensusColumnFatherBirthPlaceSimple::class, $columns[13]);
        $this->assertInstanceOf(CensusColumnMotherBirthPlaceSimple::class, $columns[14]);
        ...
        $this->assertInstanceOf(CensusColumnOccupation::class, $columns[19]);
