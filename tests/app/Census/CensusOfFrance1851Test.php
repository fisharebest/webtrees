...
class CensusOfFrance1851Test extends \PHPUnit_Framework_TestCase {
	...
	public function testPlaceAndDate() {
		...
		$this->assertSame('1851', $census->censusDate());
	}
	...
	public function testColumns() {
		...
		$this->assertInstanceOf('Fisharebest\Webtrees\Census\CensusColumnConditionFrench', $columns[4]);
		...
		$this->assertSame('Situtation pers.', $columns[4]->abbreviation());
		$this->assertSame('Nationalité', $columns[5]->abbreviation());
		$this->assertSame('Religion', $columns[6]->abbreviation());
		$this->assertSame('Maladies', $columns[7]->abbreviation());
		...
		$this->assertSame('Situation personnelle (marié, veuf…)', $columns[4]->title());
		$this->assertSame('Nationalité', $columns[5]->title());
		$this->assertSame('Religion', $columns[6]->title());
		$this->assertSame('Infirmités et maladies', $columns[7]->title());
	}
}
