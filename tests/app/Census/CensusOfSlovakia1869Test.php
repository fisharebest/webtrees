...
class CensusOfSlovakia1869Test extends TestCase
{
    ...
    public function testColumns(): void
    {
        ...
        $this->assertSame('Vzťah', $columns[3]->abbreviation());
        ...
        $this->assertSame('Postavenie (rodinný vzťah k hlave domácnosti)', $columns[3]->title());
        ...
        $this->assertSame('Prítomný trvácne', $columns[14]->title());
