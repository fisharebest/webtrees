 ...
 */
class CensusOfUnitedStates1880Test extends \Fisharebest\Webtrees\TestCase
{
    /**
    ...
    public function testColumns(): void
    {
        ...
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnMonthIfBornWithinYear::class, $columns[3]);
        ...
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnMarriedWithinYear::class, $columns[8]);
        ...
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnBirthPlaceSimple::class, $columns[20]);
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnFatherBirthPlaceSimple::class, $columns[21]);
        $this->assertInstanceOf(\Fisharebest\Webtrees\Census\CensusColumnMotherBirthPlaceSimple::class, $columns[22]);
