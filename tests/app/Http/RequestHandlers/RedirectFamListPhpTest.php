...
/**
 * @covers \Fisharebest\Webtrees\Http\RequestHandlers\RedirectFamListPhp
 */
class RedirectFamListPhpTest extends TestCase
{
    ...
    public function testRedirect(): void
    {
        ...
        $module = $this->createStub(FamilyListModule::class);
        $module
            ->expects(self::once())
            ->method('listUrl')
        ...
        $module_service
            ...
            ->with(FamilyListModule::class)
            ->willReturn(new Collection([$module]));

        $handler = new RedirectFamListPhp($module_service, $tree_service);
