...
/**
 * @covers \Fisharebest\Webtrees\Http\RequestHandlers\RedirectRepoListPhp
 */
class RedirectRepoListPhpTest extends TestCase
{
    ...
    public function testRedirect(): void
    {
        ...
        $handler = new RedirectRepoListPhp($module_service, $tree_service);
