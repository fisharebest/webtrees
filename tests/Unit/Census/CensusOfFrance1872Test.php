...
use Fisharebest\Webtrees\Census\CensusColumnConditionFrenchFemme;
use Fisharebest\Webtrees\Census\CensusColumnConditionFrenchFille;
use Fisharebest\Webtrees\Census\CensusColumnConditionFrenchGarcon;
use Fisharebest\Webtrees\Census\CensusColumnConditionFrenchHomme;
use Fisharebest\Webtrees\Census\CensusColumnConditionFrenchVeuf;
use Fisharebest\Webtrees\Census\CensusColumnConditionFrenchVeuve;
use Fisharebest\Webtrees\Census\CensusColumnGivenNames;
use Fisharebest\Webtrees\Census\CensusColumnOccupation;
use Fisharebest\Webtrees\Census\CensusColumnSurname;
use Fisharebest\Webtrees\Census\CensusOfFrance1872;

#[CoversClass(CensusOfFrance1872::class)]
#[CoversClass(AbstractCensusColumn::class)]
class CensusOfFrance1872Test extends TestCase
{
    public function testPlaceAndDate(): void
    {
        ...
        self::assertSame('18 JAN 1872', $census->censusDate());
    }
