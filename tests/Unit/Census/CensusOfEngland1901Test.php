...
use Fisharebest\Webtrees\Census\CensusOfEngland1901;

#[CoversClass(CensusOfEngland1901::class)]
#[CoversClass(AbstractCensusColumn::class)]
class CensusOfEngland1901Test extends TestCase
{
    ...
    public function testColumns(): void
    {
        ...
        self::assertSame('Infirm', $columns[9]->abbreviation());
        ...
        self::assertSame('Whether deaf-and-dumb, blind, lunatic, imbecile, feeble-minded', $columns[9]->title());
    }
}
