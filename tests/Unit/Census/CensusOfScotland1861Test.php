...
use Fisharebest\Webtrees\Census\CensusOfScotland1861;

#[CoversClass(CensusOfScotland1861::class)]
...
class CensusOfScotland1861Test extends TestCase
{
    public function testPlaceAndDate(): void
    {
        ...
        self::assertSame('07 APR 1861', $census->censusDate());
    }
    ...
    public function testColumns(): void
    {
        ...
        self::assertSame('Number of children between 5 and 13 attending school', $columns[8]->title());
    }
}
