...
#[CoversClass(CensusColumnConditionDanish::class)]
...
class CensusColumnConditionDanishTest extends TestCase
{
    public function testNoSpouseFamiliesMale(): void
    {
        ...
        self::assertSame('Ugift', $column->generate($individual, $individual));
    }
    ...
    public function testSpouseDeadMale(): void
    {
        ...
        self::assertSame('Gift', $column->generate($individual, $individual));
    }
    ...
    public function testDivorcedMale(): void
    {
        ...
        self::assertSame('Skilt', $column->generate($individual, $individual));
    }
