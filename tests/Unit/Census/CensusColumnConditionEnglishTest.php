...
use Fisharebest\Webtrees\Census\AbstractCensusColumnCondition;
use Fisharebest\Webtrees\Census\CensusColumnConditionEnglish;
use Fisharebest\Webtrees\Census\CensusInterface;

#[CoversClass(CensusColumnConditionEnglish::class)]
#[CoversClass(AbstractCensusColumnCondition::class)]
class CensusColumnConditionEnglishTest extends TestCase
{
    public function testNoSpouseFamiliesMale(): void
    {
        ...
        self::assertSame('Unm', $column->generate($individual, $individual));
    }
    ...
    public function testSpouseDeadMale(): void
    {
        ...
        self::assertSame('Wid', $column->generate($individual, $individual));
    }
    ...
    public function testDivorcedMale(): void
    {
        ...
        self::assertSame('Div', $column->generate($individual, $individual));
    }
