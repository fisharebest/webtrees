...
use Fisharebest\Webtrees\Census\CensusColumnFullName;
use Fisharebest\Webtrees\Census\CensusColumnNull;
use Fisharebest\Webtrees\Census\CensusOfUnitedStates1830;

#[CoversClass(CensusOfUnitedStates1830::class)]
...
class CensusOfUnitedStates1830Test extends TestCase
{
    public function testPlaceAndDate(): void
    {
        ...
        self::assertSame('01 JUN 1830', $census->censusDate());
    }
    ...
    public function testColumns(): void
    {
        ...
        self::assertInstanceOf(CensusColumnNull::class, $columns[39]);
        self::assertInstanceOf(CensusColumnNull::class, $columns[40]);
        self::assertInstanceOf(CensusColumnNull::class, $columns[41]);
        self::assertInstanceOf(CensusColumnNull::class, $columns[42]);
        self::assertInstanceOf(CensusColumnNull::class, $columns[43]);
        self::assertInstanceOf(CensusColumnNull::class, $columns[44]);
        self::assertInstanceOf(CensusColumnNull::class, $columns[45]);
        self::assertInstanceOf(CensusColumnNull::class, $columns[46]);
        self::assertInstanceOf(CensusColumnNull::class, $columns[47]);
        self::assertInstanceOf(CensusColumnNull::class, $columns[48]);
        self::assertInstanceOf(CensusColumnNull::class, $columns[49]);
        self::assertInstanceOf(CensusColumnNull::class, $columns[50]);
        ...
        self::assertSame('M0', $columns[39]->abbreviation());
        self::assertSame('M10', $columns[40]->abbreviation());
        self::assertSame('M24', $columns[41]->abbreviation());
        self::assertSame('M36', $columns[42]->abbreviation());
        self::assertSame('M55', $columns[43]->abbreviation());
        self::assertSame('M100', $columns[44]->abbreviation());
        self::assertSame('F0', $columns[45]->abbreviation());
        self::assertSame('F10', $columns[46]->abbreviation());
        self::assertSame('F24', $columns[47]->abbreviation());
        self::assertSame('F36', $columns[48]->abbreviation());
        self::assertSame('F55', $columns[49]->abbreviation());
        self::assertSame('F100', $columns[50]->abbreviation());
        ...
        self::assertSame('Slave males 0-10 years', $columns[27]->title());
        self::assertSame('Slave males 10-24 years', $columns[28]->title());
        self::assertSame('Slave males 24-36 years', $columns[29]->title());
        self::assertSame('Slave males 36-55 years', $columns[30]->title());
        self::assertSame('Slave males 55-100 years', $columns[31]->title());
        self::assertSame('Slave males 100+ years', $columns[32]->title());
        self::assertSame('Slave females 0-10 years', $columns[33]->title());
        self::assertSame('Slave females 10-24 years', $columns[34]->title());
        self::assertSame('Slave females 24-36 years', $columns[35]->title());
        self::assertSame('Slave females 36-55 years', $columns[36]->title());
        self::assertSame('Slave females 55-100 years', $columns[37]->title());
        self::assertSame('Slave females 100+ years', $columns[38]->title());
        self::assertSame('Free colored males 0-10 years', $columns[39]->title());
        self::assertSame('Free colored males 10-24 years', $columns[40]->title());
        self::assertSame('Free colored males 24-36 years', $columns[41]->title());
        self::assertSame('Free colored males 36-55 years', $columns[42]->title());
        self::assertSame('Free colored males 55-100 years', $columns[43]->title());
        self::assertSame('Free colored males 100+ years', $columns[44]->title());
        self::assertSame('Free colored females 0-10 years', $columns[45]->title());
        self::assertSame('Free colored females 10-24 years', $columns[46]->title());
        self::assertSame('Free colored females 24-36 years', $columns[47]->title());
        self::assertSame('Free colored females 36-55 years', $columns[48]->title());
        self::assertSame('Free colored females 55-100 years', $columns[49]->title());
        self::assertSame('Free colored females 100+ years', $columns[50]->title());
    }
}
