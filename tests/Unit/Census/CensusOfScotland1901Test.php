...
use Fisharebest\Webtrees\Census\CensusColumnAgeFemale;
use Fisharebest\Webtrees\Census\CensusColumnAgeMale;
use Fisharebest\Webtrees\Census\CensusColumnBirthPlace;
use Fisharebest\Webtrees\Census\CensusColumnConditionEnglish;
use Fisharebest\Webtrees\Census\CensusColumnFullName;
use Fisharebest\Webtrees\Census\CensusColumnNull;
use Fisharebest\Webtrees\Census\CensusColumnOccupation;
use Fisharebest\Webtrees\Census\CensusColumnRelationToHeadEnglish;
use Fisharebest\Webtrees\Census\CensusOfScotland1901;

#[CoversClass(CensusOfScotland1901::class)]
#[CoversClass(AbstractCensusColumn::class)]
class CensusOfScotland1901Test extends TestCase
{
    ...
    public function testColumns(): void
    {
        ...
        self::assertSame('Emp', $columns[6]->abbreviation());
        self::assertSame('Home', $columns[7]->abbreviation());
        self::assertSame('Birthplace', $columns[8]->abbreviation());
        self::assertSame('Lang', $columns[9]->abbreviation());
        ...
        self::assertSame('Employer, worker or own account', $columns[6]->title());
        self::assertSame('Working at home', $columns[7]->title());
        self::assertSame('Where born', $columns[8]->title());
        self::assertSame('Language spoken', $columns[9]->title());
        self::assertSame('Whether deaf-and-dumb, blind, lunatic, imbecile, feeble-minded', $columns[10]->title());
    }
}
