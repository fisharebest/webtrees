...
class RedirectTimeLinePhpTest extends TestCase
{
    ...
    public function testRedirect(): void
    {
        ...
        $controller = new RedirectTimeLinePhp(new GuestUser(), $module_service, $tree_service);

        $request = self::createRequest(HttpRequestMethod::GET->value, ['ged' => 'tree1', 'pids' => ['X123']]);
