...
class PortugueseTest extends AbstractPortugueseTestCase
{
    ...
    {
        self::assertSame('pt', self::language()->languageTag());
    }
    public function testEndonym(): void
    {
        self::assertSame('portugus', self::language()->endonym());
    }
    ...
    public static function dateProvider(): array
    {
        return [
            ...
            ['@#DHIJRI@ 15 RAMAD 1425', '15 Ramadão 1425'],
            ['@#DHIJRI@ RAMAD 1425', 'Ramadão 1425'],
            ['ABT @#DHIJRI@ RAMAD 1425', 'por volta de Ramadão 1425'],
            ['FROM @#DHIJRI@ RAMAD 1425', 'de Ramadão 1425'],
            ['AFT @#DHIJRI@ RAMAD 1425', 'depois de Ramadão 1425'],
            ['BEF @#DHIJRI@ RAMAD 1425', 'antes de Ramadão 1425'],
