...
#[CoversClass(Malay::class)]
class MalayTest extends AbstractLanguageTestCase
{
    ...
    {
        self::assertSame('ms', self::language()->languageTag());
    }
    public function testEndonym(): void
    {
        self::assertSame('Melayu', self::language()->endonym());
    }
    ...
    public static function dateProvider(): array
    {
        return [
            ...
            ['ABT JAN 2000', 'about Januari 2000'],
            ['FROM JAN 2000', 'from Januari 2000'],
            ['AFT JAN 2000', 'after Januari 2000'],
            ['BEF JAN 2000', 'before Januari 2000'],
            ['15 FEB 2000', '15 Februari 2000'],
            ['FEB 2000', 'Februari 2000'],
            ['ABT FEB 2000', 'about Februari 2000'],
            ['FROM FEB 2000', 'from Februari 2000'],
            ['AFT FEB 2000', 'after Februari 2000'],
            ['BEF FEB 2000', 'before Februari 2000'],
            ['15 MAR 2000', '15 Mac 2000'],
            ['MAR 2000', 'Mac 2000'],
            ['ABT MAR 2000', 'about Mac 2000'],
            ['FROM MAR 2000', 'from Mac 2000'],
            ['AFT MAR 2000', 'after Mac 2000'],
            ['BEF MAR 2000', 'before Mac 2000'],
            ...
            ['JUN 2000', 'Jun 2000'],
            ['ABT JUN 2000', 'about Jun 2000'],
            ['FROM JUN 2000', 'from Jun 2000'],
            ['AFT JUN 2000', 'after Jun 2000'],
            ['BEF JUN 2000', 'before Jun 2000'],
            ['15 JUL 2000', '15 Julai 2000'],
            ['JUL 2000', 'Julai 2000'],
            ['ABT JUL 2000', 'about Julai 2000'],
            ['FROM JUL 2000', 'from Julai 2000'],
            ['AFT JUL 2000', 'after Julai 2000'],
            ['BEF JUL 2000', 'before Julai 2000'],
            ['15 AUG 2000', '15 Ogos 2000'],
            ['AUG 2000', 'Ogos 2000'],
            ['ABT AUG 2000', 'about Ogos 2000'],
            ['FROM AUG 2000', 'from Ogos 2000'],
            ['AFT AUG 2000', 'after Ogos 2000'],
            ['BEF AUG 2000', 'before Ogos 2000'],
            ...
            ['ABT OCT 2000', 'about Oktober 2000'],
            ['FROM OCT 2000', 'from Oktober 2000'],
            ['AFT OCT 2000', 'after Oktober 2000'],
            ['BEF OCT 2000', 'before Oktober 2000'],
            ...
            ['15 DEC 2000', '15 Disember 2000'],
            ['DEC 2000', 'Disember 2000'],
            ['ABT DEC 2000', 'about Disember 2000'],
            ['FROM DEC 2000', 'from Disember 2000'],
            ['AFT DEC 2000', 'after Disember 2000'],
            ['BEF DEC 2000', 'before Disember 2000'],
            ['2000', '2000'],
            ['ABT 15 JAN 2000', 'about 15 Januari 2000'],
            ['CAL 15 JAN 2000', 'calculated 15 Januari 2000'],
            ['EST 15 JAN 2000', 'estimated 15 Januari 2000'],
            ['BEF 15 JAN 2000', 'before 15 Januari 2000'],
            ['AFT 15 JAN 2000', 'after 15 Januari 2000'],
            ['FROM 15 JAN 2000', 'from 15 Januari 2000'],
            ['TO 15 JAN 2000', 'to 15 Januari 2000'],
            ['BET 15 JAN 2000 AND 15 FEB 2000', 'between 15 Januari 2000 and 15 Februari 2000'],
            ['FROM 15 JAN 2000 TO 15 FEB 2000', 'from 15 Januari 2000 to 15 Februari 2000'],
            ['INT 15 JAN 2000', 'interpreted 15 Januari 2000'],
            ['@#DJULIAN@ 15 JAN 1700', '15 Januari 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ JAN 1700', 'Januari 1700  Sebelum Tahun Masihi'],
            ['ABT @#DJULIAN@ JAN 1700', 'about Januari 1700  Sebelum Tahun Masihi'],
            ['FROM @#DJULIAN@ JAN 1700', 'from Januari 1700  Sebelum Tahun Masihi'],
            ['AFT @#DJULIAN@ JAN 1700', 'after Januari 1700  Sebelum Tahun Masihi'],
            ['BEF @#DJULIAN@ JAN 1700', 'before Januari 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ 15 FEB 1700', '15 Februari 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ FEB 1700', 'Februari 1700  Sebelum Tahun Masihi'],
            ['ABT @#DJULIAN@ FEB 1700', 'about Februari 1700  Sebelum Tahun Masihi'],
            ['FROM @#DJULIAN@ FEB 1700', 'from Februari 1700  Sebelum Tahun Masihi'],
            ['AFT @#DJULIAN@ FEB 1700', 'after Februari 1700  Sebelum Tahun Masihi'],
            ['BEF @#DJULIAN@ FEB 1700', 'before Februari 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ 15 MAR 1700', '15 Mac 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ MAR 1700', 'Mac 1700  Sebelum Tahun Masihi'],
            ['ABT @#DJULIAN@ MAR 1700', 'about Mac 1700  Sebelum Tahun Masihi'],
            ['FROM @#DJULIAN@ MAR 1700', 'from Mac 1700  Sebelum Tahun Masihi'],
            ['AFT @#DJULIAN@ MAR 1700', 'after Mac 1700  Sebelum Tahun Masihi'],
            ['BEF @#DJULIAN@ MAR 1700', 'before Mac 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ 15 APR 1700', '15 April 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ 14 APR 1645/46', '14 April 1645/46  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ APR 1700', 'April 1700  Sebelum Tahun Masihi'],
            ['ABT @#DJULIAN@ APR 1700', 'about April 1700  Sebelum Tahun Masihi'],
            ['FROM @#DJULIAN@ APR 1700', 'from April 1700  Sebelum Tahun Masihi'],
            ['AFT @#DJULIAN@ APR 1700', 'after April 1700  Sebelum Tahun Masihi'],
            ['BEF @#DJULIAN@ APR 1700', 'before April 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ 15 MAY 1700', '15 Mei 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ MAY 1700', 'Mei 1700  Sebelum Tahun Masihi'],
            ['ABT @#DJULIAN@ MAY 1700', 'about Mei 1700  Sebelum Tahun Masihi'],
            ['FROM @#DJULIAN@ MAY 1700', 'from Mei 1700  Sebelum Tahun Masihi'],
            ['AFT @#DJULIAN@ MAY 1700', 'after Mei 1700  Sebelum Tahun Masihi'],
            ['BEF @#DJULIAN@ MAY 1700', 'before Mei 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ 15 JUN 1700', '15 Jun 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ JUN 1700', 'Jun 1700  Sebelum Tahun Masihi'],
            ['ABT @#DJULIAN@ JUN 1700', 'about Jun 1700  Sebelum Tahun Masihi'],
            ['FROM @#DJULIAN@ JUN 1700', 'from Jun 1700  Sebelum Tahun Masihi'],
            ['AFT @#DJULIAN@ JUN 1700', 'after Jun 1700  Sebelum Tahun Masihi'],
            ['BEF @#DJULIAN@ JUN 1700', 'before Jun 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ 15 JUL 1700', '15 Julai 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ JUL 1700', 'Julai 1700  Sebelum Tahun Masihi'],
            ['ABT @#DJULIAN@ JUL 1700', 'about Julai 1700  Sebelum Tahun Masihi'],
            ['FROM @#DJULIAN@ JUL 1700', 'from Julai 1700  Sebelum Tahun Masihi'],
            ['AFT @#DJULIAN@ JUL 1700', 'after Julai 1700  Sebelum Tahun Masihi'],
            ['BEF @#DJULIAN@ JUL 1700', 'before Julai 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ 15 AUG 1700', '15 Ogos 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ AUG 1700', 'Ogos 1700  Sebelum Tahun Masihi'],
            ['ABT @#DJULIAN@ AUG 1700', 'about Ogos 1700  Sebelum Tahun Masihi'],
            ['FROM @#DJULIAN@ AUG 1700', 'from Ogos 1700  Sebelum Tahun Masihi'],
            ['AFT @#DJULIAN@ AUG 1700', 'after Ogos 1700  Sebelum Tahun Masihi'],
            ['BEF @#DJULIAN@ AUG 1700', 'before Ogos 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ 15 SEP 1700', '15 September 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ SEP 1700', 'September 1700  Sebelum Tahun Masihi'],
            ['ABT @#DJULIAN@ SEP 1700', 'about September 1700  Sebelum Tahun Masihi'],
            ['FROM @#DJULIAN@ SEP 1700', 'from September 1700  Sebelum Tahun Masihi'],
            ['AFT @#DJULIAN@ SEP 1700', 'after September 1700  Sebelum Tahun Masihi'],
            ['BEF @#DJULIAN@ SEP 1700', 'before September 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ 15 OCT 1700', '15 Oktober 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ OCT 1700', 'Oktober 1700  Sebelum Tahun Masihi'],
            ['ABT @#DJULIAN@ OCT 1700', 'about Oktober 1700  Sebelum Tahun Masihi'],
            ['FROM @#DJULIAN@ OCT 1700', 'from Oktober 1700  Sebelum Tahun Masihi'],
            ['AFT @#DJULIAN@ OCT 1700', 'after Oktober 1700  Sebelum Tahun Masihi'],
            ['BEF @#DJULIAN@ OCT 1700', 'before Oktober 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ 15 NOV 1700', '15 November 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ NOV 1700', 'November 1700  Sebelum Tahun Masihi'],
            ['ABT @#DJULIAN@ NOV 1700', 'about November 1700  Sebelum Tahun Masihi'],
            ['FROM @#DJULIAN@ NOV 1700', 'from November 1700  Sebelum Tahun Masihi'],
            ['AFT @#DJULIAN@ NOV 1700', 'after November 1700  Sebelum Tahun Masihi'],
            ['BEF @#DJULIAN@ NOV 1700', 'before November 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ 15 DEC 1700', '15 Disember 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ DEC 1700', 'Disember 1700  Sebelum Tahun Masihi'],
            ['ABT @#DJULIAN@ DEC 1700', 'about Disember 1700  Sebelum Tahun Masihi'],
            ['FROM @#DJULIAN@ DEC 1700', 'from Disember 1700  Sebelum Tahun Masihi'],
            ['AFT @#DJULIAN@ DEC 1700', 'after Disember 1700  Sebelum Tahun Masihi'],
            ['BEF @#DJULIAN@ DEC 1700', 'before Disember 1700  Sebelum Tahun Masihi'],
            ['@#DJULIAN@ 1700', '1700  Sebelum Tahun Masihi'],
            ['ABT @#DJULIAN@ 15 JAN 1700', 'about 15 Januari 1700  Sebelum Tahun Masihi'],
            ['CAL @#DJULIAN@ 15 JAN 1700', 'calculated 15 Januari 1700  Sebelum Tahun Masihi'],
            ['EST @#DJULIAN@ 15 JAN 1700', 'estimated 15 Januari 1700  Sebelum Tahun Masihi'],
            ['BEF @#DJULIAN@ 15 JAN 1700', 'before 15 Januari 1700  Sebelum Tahun Masihi'],
            ['AFT @#DJULIAN@ 15 JAN 1700', 'after 15 Januari 1700  Sebelum Tahun Masihi'],
            ['FROM @#DJULIAN@ 15 JAN 1700', 'from 15 Januari 1700  Sebelum Tahun Masihi'],
            ['TO @#DJULIAN@ 15 JAN 1700', 'to 15 Januari 1700  Sebelum Tahun Masihi'],
            ['BET @#DJULIAN@ 15 JAN 1700 AND @#DJULIAN@ 15 FEB 1700', 'between 15 Januari 1700  Sebelum Tahun Masihi and 15 Februari 1700  Sebelum Tahun Masihi'],
            ['FROM @#DJULIAN@ 15 JAN 1700 TO @#DJULIAN@ 15 FEB 1700', 'from 15 Januari 1700  Sebelum Tahun Masihi to 15 Februari 1700  Sebelum Tahun Masihi'],
            ['INT @#DJULIAN@ 15 JAN 1700', 'interpreted 15 Januari 1700  Sebelum Tahun Masihi'],
            ...
            ['@#DHIJRI@ 15 RABIA 1425', '15 Rabiulawal 1425'],
            ['@#DHIJRI@ RABIA 1425', 'Rabiulawal 1425'],
            ['ABT @#DHIJRI@ RABIA 1425', 'about Rabiulawal 1425'],
            ['FROM @#DHIJRI@ RABIA 1425', 'from Rabiulawal 1425'],
            ['AFT @#DHIJRI@ RABIA 1425', 'after Rabiulawal 1425'],
            ['BEF @#DHIJRI@ RABIA 1425', 'before Rabiulawal 1425'],
            ['@#DHIJRI@ 15 RABIT 1425', '15 Rabiulakhir 1425'],
            ['@#DHIJRI@ RABIT 1425', 'Rabiulakhir 1425'],
            ['ABT @#DHIJRI@ RABIT 1425', 'about Rabiulakhir 1425'],
            ['FROM @#DHIJRI@ RABIT 1425', 'from Rabiulakhir 1425'],
            ['AFT @#DHIJRI@ RABIT 1425', 'after Rabiulakhir 1425'],
            ['BEF @#DHIJRI@ RABIT 1425', 'before Rabiulakhir 1425'],
            ['@#DHIJRI@ 15 JUMAA 1425', '15 Jamadilawal 1425'],
            ['@#DHIJRI@ JUMAA 1425', 'Jamadilawal 1425'],
            ['ABT @#DHIJRI@ JUMAA 1425', 'about Jamadilawal 1425'],
            ['FROM @#DHIJRI@ JUMAA 1425', 'from Jamadilawal 1425'],
            ['AFT @#DHIJRI@ JUMAA 1425', 'after Jamadilawal 1425'],
            ['BEF @#DHIJRI@ JUMAA 1425', 'before Jamadilawal 1425'],
            ['@#DHIJRI@ 15 JUMAT 1425', '15 Jamadilakhir 1425'],
            ['@#DHIJRI@ JUMAT 1425', 'Jamadilakhir 1425'],
            ['ABT @#DHIJRI@ JUMAT 1425', 'about Jamadilakhir 1425'],
            ['FROM @#DHIJRI@ JUMAT 1425', 'from Jamadilakhir 1425'],
            ['AFT @#DHIJRI@ JUMAT 1425', 'after Jamadilakhir 1425'],
            ['BEF @#DHIJRI@ JUMAT 1425', 'before Jamadilakhir 1425'],
            ['@#DHIJRI@ 15 RAJAB 1425', '15 Rejab 1425'],
            ['@#DHIJRI@ RAJAB 1425', 'Rejab 1425'],
            ['ABT @#DHIJRI@ RAJAB 1425', 'about Rejab 1425'],
            ['FROM @#DHIJRI@ RAJAB 1425', 'from Rejab 1425'],
            ['AFT @#DHIJRI@ RAJAB 1425', 'after Rejab 1425'],
            ['BEF @#DHIJRI@ RAJAB 1425', 'before Rejab 1425'],
            ['@#DHIJRI@ 15 SHAAB 1425', '15 Syaaban 1425'],
            ['@#DHIJRI@ SHAAB 1425', 'Syaaban 1425'],
            ['ABT @#DHIJRI@ SHAAB 1425', 'about Syaaban 1425'],
            ['FROM @#DHIJRI@ SHAAB 1425', 'from Syaaban 1425'],
            ['AFT @#DHIJRI@ SHAAB 1425', 'after Syaaban 1425'],
            ['BEF @#DHIJRI@ SHAAB 1425', 'before Syaaban 1425'],
            ...
            ['ABT @#DHIJRI@ SHAWW 1425', 'about Syawal 1425'],
            ['FROM @#DHIJRI@ SHAWW 1425', 'from Syawal 1425'],
            ['AFT @#DHIJRI@ SHAWW 1425', 'after Syawal 1425'],
            ['BEF @#DHIJRI@ SHAWW 1425', 'before Syawal 1425'],
            ['@#DHIJRI@ 15 DHUAQ 1425', '15 Zulkaedah 1425'],
            ['@#DHIJRI@ DHUAQ 1425', 'Zulkaedah 1425'],
            ['ABT @#DHIJRI@ DHUAQ 1425', 'about Zulkaedah 1425'],
            ['FROM @#DHIJRI@ DHUAQ 1425', 'from Zulkaedah 1425'],
            ['AFT @#DHIJRI@ DHUAQ 1425', 'after Zulkaedah 1425'],
            ['BEF @#DHIJRI@ DHUAQ 1425', 'before Zulkaedah 1425'],
    ...
    public function testRelationships(): void
    {
        ...
        // Partners
        self::assertRelationshipNames('isteri', 'suami', [$husband, $fm, $wife]);
        self::assertRelationshipNames('bekas suami', 'bekas isteri', [$wife, $fd, $exHusband]);
        self::assertRelationshipNames('tunang perempuan', 'tunang lelaki', [$fiance, $fe, $engaged]);

        // Parents / Children
        self::assertRelationshipNames('ibu', 'anak lelaki', [$son, $fm, $wife]);
        self::assertRelationshipNames('bapa', 'anak lelaki', [$son, $fm, $husband]);
        self::assertRelationshipNames('ibu', 'anak perempuan', [$daughter, $fm, $wife]);

        // Adopted / Fostered
        self::assertRelationshipNames('ibu angkat', 'anak lelaki angkat', [$adoptedSon, $fd, $wife]);
        ...
        self::assertRelationshipNames('kakak perempuan', 'adik lelaki', [$son, $fm, $daughter]);
        self::assertRelationshipNames('adik lelaki', 'kakak perempuan', [$daughter, $fm, $son]);

        // Stepfamily
        self::assertRelationshipName('bapa tiri', [$stepDaughter, $fd, $wife, $fm, $husband]);
        self::assertRelationshipName('anak perempuan tiri', [$husband, $fm, $wife, $fd, $stepDaughter]);

        // In-laws — spouse's parents
        self::assertRelationshipName('ibu mertua', [$husband, $fm, $wife, $fw, $motherOfW]);
        self::assertRelationshipName('bapa mertua', [$husband, $fm, $wife, $fw, $fatherOfW]);
        self::assertRelationshipName('ibu mertua', [$wife, $fm, $husband, $fp, $motherOfH]);
        self::assertRelationshipName('bapa mertua', [$wife, $fm, $husband, $fp, $fatherOfH]);

        // In-laws — child's spouse
        self::assertRelationshipName('menantu perempuan', [$husband, $fm, $son, $fson, $wifeOfSon]);
        self::assertRelationshipName('menantu lelaki', [$husband, $fm, $daughter, $fdau, $husbandOfDaughter]);

        // In-laws — spouse's siblings
        self::assertRelationshipName('ipar lelaki', [$husband, $fm, $wife, $fw, $brotherOfW]);
        ...
        self::assertRelationshipName('datuk', [$son, $fm, $husband, $fp, $fatherOfH]);
        self::assertRelationshipName('nenek', [$son, $fm, $wife, $fw, $motherOfW]);
        self::assertRelationshipName('datuk', [$son, $fm, $wife, $fw, $fatherOfW]);

        // Grandchildren
        self::assertRelationshipName('cucu lelaki', [$fatherOfH, $fp, $husband, $fm, $son]);
        self::assertRelationshipName('cucu perempuan', [$fatherOfH, $fp, $husband, $fm, $daughter]);

        // Aunts/Uncles
        self::assertRelationshipName('mak saudara', [$son, $fm, $husband, $fp, $sisterOfH]);
        self::assertRelationshipName('pak saudara', [$son, $fm, $husband, $fp, $brotherOfH]);
        self::assertRelationshipName('mak saudara', [$son, $fm, $wife, $fw, $sisterOfW]);
        self::assertRelationshipName('pak saudara', [$son, $fm, $wife, $fw, $brotherOfW]);

        // Nieces/Nephews
        self::assertRelationshipName('anak saudara perempuan', [$husband, $fp, $brotherOfH, $fbro, $nieceFromBro]);
        self::assertRelationshipName('anak saudara lelaki', [$husband, $fp, $brotherOfH, $fbro, $nephewFromBro]);
        self::assertRelationshipName('anak saudara perempuan', [$husband, $fp, $sisterOfH, $fsis, $nieceFromSis]);
        self::assertRelationshipName('anak saudara lelaki', [$husband, $fp, $sisterOfH, $fsis, $nephewFromSis]);

        // Cousins
        self::assertRelationshipName('sepupu lelaki', [$son, $fm, $husband, $fp, $brotherOfH, $fbro, $cousinM]);
        ...
        self::assertRelationshipName('datuk buyut', [$son, $fm, $husband, $fp, $motherOfH, $fgp, $paternalGF]);

        // Great-aunt/uncle (dynamic — grandparent's sibling, n=2)
        self::assertRelationshipName('mak saudara', [$son, $fm, $husband, $fp, $motherOfH, $fgp, $greatAunt]);
        self::assertRelationshipName('pak saudara', [$son, $fm, $husband, $fp, $motherOfH, $fgp, $greatUncle]);
    }
}
