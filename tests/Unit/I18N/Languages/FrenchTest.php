...
class FrenchTest extends AbstractFrenchTestCase
{
    ...
    public static function dateProvider(): array
    {
        return [
            ...
            ['FROM @#DJULIAN@ APR 1700', 'd’avril 1700 de notre ère'],
            ...
            ['FROM @#DJULIAN@ AUG 1700', 'd’août 1700 de notre ère'],
            ...
            ['FROM @#DJULIAN@ OCT 1700', 'd’octobre 1700 de notre ère'],
            ...
            ['FROM @#DHEBREW@ ELL 5765', 'd’eloul 5765'],
