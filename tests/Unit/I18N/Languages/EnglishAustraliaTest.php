...
#[CoversClass(EnglishAustralia::class)]
class EnglishAustraliaTest extends EnglishGreatBritainTest
{
    protected static function language(): LanguageInterface
    {
        return new EnglishAustralia();
    }
    ...
    {
        self::assertSame('en-AU', self::language()->languageTag());
    }
