...
class GermanTest extends AbstractLanguageTestCase
{
    ...
    public static function dateProvider(): array
    {
        return [
            ...
            ['FROM SEP 2000', 'ab September 2000'],
            ...
            ['FROM NOV 2000', 'ab November 2000'],
            ...
            ['FROM DEC 2000', 'ab Dezember 2000'],
            ...
            ['FROM @#DJULIAN@ JAN 1700', 'ab Januar 1700&#7478;&#7489;&#7480;'],
            ...
            ['FROM @#DJULIAN@ FEB 1700', 'ab Februar 1700&#7478;&#7489;&#7480;'],
            ...
            ['FROM @#DJULIAN@ MAR 1700', 'ab März 1700&#7478;&#7489;&#7480;'],
            ...
            ['FROM @#DJULIAN@ APR 1700', 'ab April 1700&#7478;&#7489;&#7480;'],
            ...
            ['FROM @#DJULIAN@ MAY 1700', 'ab Mai 1700&#7478;&#7489;&#7480;'],
            ...
            ['FROM @#DJULIAN@ JUN 1700', 'ab Juni 1700&#7478;&#7489;&#7480;'],
            ...
            ['FROM @#DJULIAN@ JUL 1700', 'ab Juli 1700&#7478;&#7489;&#7480;'],
            ...
            ['FROM @#DJULIAN@ AUG 1700', 'ab August 1700&#7478;&#7489;&#7480;'],
            ...
            ['FROM @#DJULIAN@ SEP 1700', 'ab September 1700&#7478;&#7489;&#7480;'],
            ...
            ['FROM @#DJULIAN@ OCT 1700', 'ab Oktober 1700&#7478;&#7489;&#7480;'],
            ...
            ['FROM @#DJULIAN@ NOV 1700', 'ab November 1700&#7478;&#7489;&#7480;'],
            ...
            ['FROM @#DJULIAN@ DEC 1700', 'ab Dezember 1700&#7478;&#7489;&#7480;'],
            ...
            ['FROM @#DJULIAN@ 15 JAN 1700', 'ab 15. Januar 1700&#7478;&#7489;&#7480;'],
            ...
            ['FROM @#DJULIAN@ 15 JAN 1700 TO @#DJULIAN@ 15 FEB 1700', 'ab 15. Januar 1700&#7478;&#7489;&#7480; bis 15. Februar 1700&#7478;&#7489;&#7480;'],
            ...
            ['FROM @#DHEBREW@ TSH 5765', 'ab Tischri 5765'],
            ...
            ['FROM @#DHEBREW@ CSH 5765', 'ab Cheschwan 5765'],
            ...
            ['FROM @#DHEBREW@ KSL 5765', 'ab Kislew 5765'],
            ...
            ['FROM @#DHEBREW@ TVT 5765', 'ab Tewet 5765'],
            ...
            ['FROM @#DHEBREW@ SHV 5765', 'ab Schwat 5765'],
            ...
            ['FROM @#DHEBREW@ ADR 5765', 'ab Adar I 5765'],
            ...
            ['FROM @#DHEBREW@ ADS 5765', 'ab Adar II 5765'],
            ...
            ['FROM @#DHEBREW@ NSN 5765', 'ab Nisan 5765'],
            ...
            ['FROM @#DHEBREW@ IYR 5765', 'ab Ijar 5765'],
            ...
            ['FROM @#DHEBREW@ SVN 5765', 'ab Siwan 5765'],
            ...
            ['FROM @#DHEBREW@ TMZ 5765', 'ab Tammus 5765'],
            ...
            ['FROM @#DHEBREW@ AAV 5765', 'ab Aw 5765'],
            ...
            ['FROM @#DHEBREW@ ELL 5765', 'ab Elul 5765'],
            ...
            ['FROM @#DHEBREW@ 15 TSH 5765', 'ab 15. Tischri 5765'],
            ...
            ['FROM @#DHEBREW@ 15 TSH 5765 TO @#DHEBREW@ 15 CSH 5765', 'ab 15. Tischri 5765 bis 15. Cheschwan 5765'],
            ...
            ['FROM @#DFRENCH R@ VEND 12', 'ab Vendémiaire An XII'],
            ...
            ['FROM @#DFRENCH R@ BRUM 12', 'ab Brumaire An XII'],
            ...
            ['FROM @#DFRENCH R@ FRIM 12', 'ab Frimaire An XII'],
            ...
            ['FROM @#DFRENCH R@ NIVO 12', 'ab Nivôse An XII'],
            ...
            ['FROM @#DFRENCH R@ PLUV 12', 'ab Pluviôse An XII'],
            ...
            ['FROM @#DFRENCH R@ VENT 12', 'ab Ventôse An XII'],
            ...
            ['FROM @#DFRENCH R@ GERM 12', 'ab Germinal An XII'],
            ...
            ['FROM @#DFRENCH R@ FLOR 12', 'ab Floréal An XII'],
            ...
            ['FROM @#DFRENCH R@ PRAI 12', 'ab Prairial An XII'],
            ...
            ['FROM @#DFRENCH R@ MESS 12', 'ab Messidor An XII'],
            ...
            ['FROM @#DFRENCH R@ THER 12', 'ab Thermidor An XII'],
            ...
            ['FROM @#DFRENCH R@ FRUC 12', 'ab Fructidor An XII'],
            ...
            ['FROM @#DFRENCH R@ COMP 12', 'ab Ergänzungungstage An XII'],
            ...
            ['FROM @#DFRENCH R@ 15 VEND 12', 'ab 15. Vendémiaire An XII'],
            ...
            ['FROM @#DFRENCH R@ 15 VEND 12 TO @#DFRENCH R@ 15 BRUM 12', 'ab 15. Vendémiaire An XII bis 15. Brumaire An XII'],
            ...
            ['FROM @#DHIJRI@ MUHAR 1425', 'ab Muharram 1425'],
            ...
            ['FROM @#DHIJRI@ SAFAR 1425', 'ab Safar 1425'],
            ...
            ['FROM @#DHIJRI@ RABIA 1425', 'ab Rabiʿ al-awwal 1425'],
            ...
            ['FROM @#DHIJRI@ RABIT 1425', 'ab Rabiʿ al-thani 1425'],
            ...
            ['FROM @#DHIJRI@ JUMAA 1425', 'ab Dschumādā l-ūlā 1425'],
            ...
            ['FROM @#DHIJRI@ JUMAT 1425', 'ab Dschumādā th-thāniya 1425'],
            ...
            ['FROM @#DHIJRI@ RAJAB 1425', 'ab Rajab 1425'],
            ...
            ['FROM @#DHIJRI@ SHAAB 1425', 'ab Schaʿbān 1425'],
            ...
            ['FROM @#DHIJRI@ RAMAD 1425', 'ab Ramadan 1425'],
            ...
            ['FROM @#DHIJRI@ SHAWW 1425', 'ab Schawwāl 1425'],
            ...
            ['FROM @#DHIJRI@ DHUAQ 1425', 'ab Dhu al-Qiʿdah 1425'],
            ...
            ['FROM @#DHIJRI@ DHUAL 1425', 'ab 1425'],
            ...
            ['FROM @#DHIJRI@ 15 MUHAR 1425', 'ab 15. Muharram 1425'],
            ...
            ['FROM @#DHIJRI@ 15 MUHAR 1425 TO @#DHIJRI@ 15 SAFAR 1425', 'ab 15. Muharram 1425 bis 15. Safar 1425'],
            ...
            ['FROM @#DJALALI@ FARVA 1384', 'ab Farvardin 1384'],
            ...
            ['FROM @#DJALALI@ ORDIB 1384', 'ab Ordibehesht 1384'],
            ...
            ['FROM @#DJALALI@ KHORD 1384', 'ab Khordad 1384'],
            ...
            ['FROM @#DJALALI@ TIR 1384', 'ab Tir 1384'],
            ...
            ['FROM @#DJALALI@ MORDA 1384', 'ab Mordad 1384'],
            ...
            ['FROM @#DJALALI@ SHAHR 1384', 'ab Shahrivar 1384'],
            ...
            ['FROM @#DJALALI@ MEHR 1384', 'ab Mehr 1384'],
            ...
            ['FROM @#DJALALI@ ABAN 1384', 'ab Aban 1384'],
            ...
            ['FROM @#DJALALI@ AZAR 1384', 'ab Azar 1384'],
            ...
            ['FROM @#DJALALI@ DEY 1384', 'ab Dey 1384'],
            ...
            ['FROM @#DJALALI@ BAHMA 1384', 'ab Bahman 1384'],
            ...
            ['FROM @#DJALALI@ ESFAN 1384', 'ab Esfand 1384'],
            ...
            ['FROM @#DJALALI@ 15 FARVA 1384', 'ab 15. Farvardin 1384'],
            ...
            ['FROM @#DJALALI@ 15 FARVA 1384 TO @#DJALALI@ 15 ORDIB 1384', 'ab 15. Farvardin 1384 bis 15. Ordibehesht 1384'],
