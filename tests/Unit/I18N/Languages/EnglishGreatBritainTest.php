...
#[CoversClass(EnglishGreatBritain::class)]
class EnglishGreatBritainTest extends AbstractLanguageTestCase
{
    protected static function language(): LanguageInterface
    {
        return new EnglishGreatBritain();
    }
    ...
    {
        self::assertSame('en-GB', self::language()->languageTag());
    }
    public function testEndonym(): void
    {
        self::assertSame('British English', self::language()->endonym());
    }
    ...
    public static function dateProvider(): array
    {
        return [
            ...
            ['2000', '2000'],
            ['ABT 15 JAN 2000', 'about 15 January 2000'],
            ['CAL 15 JAN 2000', 'calculated 15 January 2000'],
            ['EST 15 JAN 2000', 'estimated 15 January 2000'],
            ['BEF 15 JAN 2000', 'before 15 January 2000'],
            ['AFT 15 JAN 2000', 'after 15 January 2000'],
            ['FROM 15 JAN 2000', 'from 15 January 2000'],
            ['TO 15 JAN 2000', 'to 15 January 2000'],
            ['BET 15 JAN 2000 AND 15 FEB 2000', 'between 15 January 2000 and 15 February 2000'],
            ['FROM 15 JAN 2000 TO 15 FEB 2000', 'from 15 January 2000 to 15 February 2000'],
            ['INT 15 JAN 2000', 'interpreted 15 January 2000'],
            ['@#DJULIAN@ 15 JAN 1700', '15 January 1700 ᴄᴇ'],
            ...
            ['@#DJULIAN@ 15 FEB 1700', '15 February 1700 ᴄᴇ'],
            ...
            ['@#DJULIAN@ 15 MAR 1700', '15 March 1700 ᴄᴇ'],
            ...
            ['@#DJULIAN@ 15 JUN 1700', '15 June 1700 ᴄᴇ'],
            ...
            ['@#DJULIAN@ 15 JUL 1700', '15 July 1700 ᴄᴇ'],
            ...
            ['@#DJULIAN@ 15 SEP 1700', '15 September 1700 ᴄᴇ'],
            ...
            ['@#DJULIAN@ 15 OCT 1700', '15 October 1700 ᴄᴇ'],
            ...
            ['@#DJULIAN@ 15 NOV 1700', '15 November 1700 ᴄᴇ'],
            ...
            ['@#DJULIAN@ 15 DEC 1700', '15 December 1700 ᴄᴇ'],
            ...
            ['ABT @#DJULIAN@ 15 JAN 1700', 'about 15 January 1700 ᴄᴇ'],
            ['CAL @#DJULIAN@ 15 JAN 1700', 'calculated 15 January 1700 ᴄᴇ'],
            ['EST @#DJULIAN@ 15 JAN 1700', 'estimated 15 January 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ 15 JAN 1700', 'before 15 January 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ 15 JAN 1700', 'after 15 January 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ 15 JAN 1700', 'from 15 January 1700 ᴄᴇ'],
            ['TO @#DJULIAN@ 15 JAN 1700', 'to 15 January 1700 ᴄᴇ'],
            ['BET @#DJULIAN@ 15 JAN 1700 AND @#DJULIAN@ 15 FEB 1700', 'between 15 January 1700 ᴄᴇ and 15 February 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ 15 JAN 1700 TO @#DJULIAN@ 15 FEB 1700', 'from 15 January 1700 ᴄᴇ to 15 February 1700 ᴄᴇ'],
            ['INT @#DJULIAN@ 15 JAN 1700', 'interpreted 15 January 1700 ᴄᴇ'],
            ...
            ['@#DHIJRI@ 1425', '1425'],
            ['ABT @#DHIJRI@ 15 MUHAR 1425', 'about 15 Muḥarram 1425'],
            ['CAL @#DHIJRI@ 15 MUHAR 1425', 'calculated 15 Muḥarram 1425'],
            ['EST @#DHIJRI@ 15 MUHAR 1425', 'estimated 15 Muḥarram 1425'],
            ['BEF @#DHIJRI@ 15 MUHAR 1425', 'before 15 Muḥarram 1425'],
            ['AFT @#DHIJRI@ 15 MUHAR 1425', 'after 15 Muḥarram 1425'],
            ['FROM @#DHIJRI@ 15 MUHAR 1425', 'from 15 Muḥarram 1425'],
            ['TO @#DHIJRI@ 15 MUHAR 1425', 'to 15 Muḥarram 1425'],
            ['BET @#DHIJRI@ 15 MUHAR 1425 AND @#DHIJRI@ 15 SAFAR 1425', 'between 15 Muḥarram 1425 and 15 Ṣafar 1425'],
            ['FROM @#DHIJRI@ 15 MUHAR 1425 TO @#DHIJRI@ 15 SAFAR 1425', 'from 15 Muḥarram 1425 to 15 Ṣafar 1425'],
            ['INT @#DHIJRI@ 15 MUHAR 1425', 'interpreted 15 Muḥarram 1425'],
    ...
    public function testRelationships(): void
    {
        ...
        // Partners
        self::assertRelationshipNames('wife', 'husband', [$husband, $fm, $wife]);
        self::assertRelationshipNames('ex-husband', 'ex-wife', [$wife, $fd, $exHusband]);
        self::assertRelationshipNames('fiancée', 'fiancé', [$fiance, $fe, $engaged]);

        // Parents
        self::assertRelationshipNames('mother', 'son', [$son, $fm, $wife]);
        self::assertRelationshipNames('father', 'son', [$son, $fm, $husband]);
        self::assertRelationshipNames('mother', 'daughter', [$daughter, $fm, $wife]);

        // Adopted
        self::assertRelationshipNames('adoptive-mother', 'adopted-son', [$adoptedSon, $fd, $wife]);
        self::assertRelationshipNames('adoptive-father', 'adopted-son', [$adoptedSon, $fd, $exHusband]);

        // Fostered
        self::assertRelationshipNames('foster-mother', 'foster-son', [$fosterSon, $fd, $wife]);
        self::assertRelationshipNames('foster-father', 'foster-son', [$fosterSon, $fd, $exHusband]);

        // Siblings
        self::assertRelationshipNames('younger sister', 'elder brother', [$son, $fm, $daughter]);
        self::assertRelationshipNames('elder brother', 'younger sister', [$daughter, $fm, $son]);

        // Half-siblings
        self::assertRelationshipName('half-brother', [$stepDaughter, $fd, $wife, $fm, $son]);

        // Stepfamily
        self::assertRelationshipName('stepfather', [$stepDaughter, $fd, $wife, $fm, $husband]);
        self::assertRelationshipName('stepdaughter', [$husband, $fm, $wife, $fd, $stepDaughter]);

        // In-laws
        self::assertRelationshipNames('mother-in-law', 'son-in-law', [$husband, $fm, $wife, $fw, $motherOfW]);
        self::assertRelationshipNames('father-in-law', 'son-in-law', [$husband, $fm, $wife, $fw, $fatherOfW]);
        self::assertRelationshipName('daughter-in-law', [$fatherOfH, $fp, $husband, $fm, $wife]);

        // Grandparents (paternal/maternal specific)
        self::assertRelationshipNames('paternal grandmother', 'grandson', [$son, $fm, $husband, $fp, $motherOfH]);
        self::assertRelationshipNames('paternal grandfather', 'grandson', [$son, $fm, $husband, $fp, $fatherOfH]);
        self::assertRelationshipNames('maternal grandmother', 'grandson', [$son, $fm, $wife, $fw, $motherOfW]);
        self::assertRelationshipNames('maternal grandfather', 'grandson', [$son, $fm, $wife, $fw, $fatherOfW]);

        // Great-grandparents (dynamic)
        self::assertRelationshipName('paternal great-grandfather', [$son, $fm, $husband, $fp, $fatherOfH, $fgp, $paternalGF]);
        self::assertRelationshipName('paternal great-grandmother', [$son, $fm, $husband, $fp, $fatherOfH, $fgp, $paternalGM]);

        // Aunts and uncles (dynamic)
        self::assertRelationshipName('aunt', [$son, $fm, $husband, $fp, $sisterOfH]);
        self::assertRelationshipName('uncle', [$son, $fm, $husband, $fp, $brotherOfH]);

        // Great-aunt/uncle (dynamic)
        self::assertRelationshipName('great-aunt', [$son, $fm, $husband, $fp, $fatherOfH, $fgp, $greatAunt]);
        self::assertRelationshipName('great-uncle', [$son, $fm, $husband, $fp, $fatherOfH, $fgp, $greatUncle]);

        // Nieces and nephews
        self::assertRelationshipName('niece', [$husband, $fp, $brotherOfH, $fbro, $nieceFromBro]);
        self::assertRelationshipName('nephew', [$husband, $fp, $brotherOfH, $fbro, $nephewFromBro]);

        // Cousins
        self::assertRelationshipName('first cousin', [$son, $fm, $husband, $fp, $brotherOfH, $fbro, $cousinFemale]);
        self::assertRelationshipName('first cousin', [$son, $fm, $husband, $fp, $brotherOfH, $fbro, $cousinMale]);
    }
}
