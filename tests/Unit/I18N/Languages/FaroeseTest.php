...
#[CoversClass(Faroese::class)]
class FaroeseTest extends AbstractLanguageTestCase
{
    ...
    {
        self::assertSame('fo', self::language()->languageTag());
    }
    public function testEndonym(): void
    {
        self::assertSame('froyskt', self::language()->endonym());
    }
    ...
    public function testFormatList(): void
    {
        ...
        self::assertSame('one ella two', $language->formatListOr(['one', 'two']));
        self::assertSame('one, two ella three', $language->formatListOr(['one', 'two', 'three']));
    }
    ...
    public function testRelationships(): void
    {
        ...
        // Partners
        self::assertRelationshipNames('kona', 'maður', [$husband, $fm, $wife]);
        self::assertRelationshipNames('fyrrverandi maður', 'fyrrverandi kona', [$wife, $fd, $exHusband]);
        self::assertRelationshipNames('trúloynd', 'trúloyndi', [$fiance, $fe, $engaged]);
        ...
        // Half-siblings
        self::assertRelationshipName('hálvbróðir', [$stepDaughter, $fd, $wife, $fm, $son]);

        // Stepfamily
        self::assertRelationshipName('stjúkfaðir', [$stepDaughter, $fd, $wife, $fm, $husband]);
        self::assertRelationshipName('stjúkdóttir', [$husband, $fm, $wife, $fd, $stepDaughter]);

        // In-laws
        self::assertRelationshipNames('vermóðir', 'versonur', [$husband, $fm, $wife, $fw, $motherOfW]);
        self::assertRelationshipNames('verfaðir', 'versonur', [$husband, $fm, $wife, $fw, $fatherOfW]);
        self::assertRelationshipName('verdóttir', [$fatherOfH, $fp, $husband, $fm, $wife]);

        // Grandparents — Faroese uses omma/abbi
        self::assertRelationshipNames('omma', 'sonarsonur', [$son, $fm, $husband, $fp, $motherOfH]);
        self::assertRelationshipNames('abbi', 'sonarsonur', [$son, $fm, $husband, $fp, $fatherOfH]);

        // Great-grandparents (dynamic) — lang prefix
        self::assertRelationshipName('langabbi', [$son, $fm, $husband, $fp, $fatherOfH, $fgp, $paternalGF]);
        self::assertRelationshipName('langomma', [$son, $fm, $husband, $fp, $fatherOfH, $fgp, $paternalGM]);
    ...
    public static function dateProvider(): array
    {
        return [
            ...
            ['ABT JAN 2000', 'about januar 2000'],
            ['FROM JAN 2000', 'from januar 2000'],
            ['AFT JAN 2000', 'after januar 2000'],
            ['BEF JAN 2000', 'before januar 2000'],
            ['15 FEB 2000', '15 februar 2000'],
            ['FEB 2000', 'februar 2000'],
            ['ABT FEB 2000', 'about februar 2000'],
            ['FROM FEB 2000', 'from februar 2000'],
            ['AFT FEB 2000', 'after februar 2000'],
            ['BEF FEB 2000', 'before februar 2000'],
            ['15 MAR 2000', '15 mars 2000'],
            ['MAR 2000', 'mars 2000'],
            ['ABT MAR 2000', 'about mars 2000'],
            ['FROM MAR 2000', 'from mars 2000'],
            ['AFT MAR 2000', 'after mars 2000'],
            ['BEF MAR 2000', 'before mars 2000'],
            ['15 APR 2000', '15 apríl 2000'],
            ['APR 2000', 'apríl 2000'],
            ['ABT APR 2000', 'about apríl 2000'],
            ['FROM APR 2000', 'from apríl 2000'],
            ['AFT APR 2000', 'after apríl 2000'],
            ['BEF APR 2000', 'before apríl 2000'],
            ...
            ['JUL 2000', 'juli 2000'],
            ['ABT JUL 2000', 'about juli 2000'],
            ['FROM JUL 2000', 'from juli 2000'],
            ['AFT JUL 2000', 'after juli 2000'],
            ['BEF JUL 2000', 'before juli 2000'],
            ...
            ['ABT DEC 2000', 'about desember 2000'],
            ['FROM DEC 2000', 'from desember 2000'],
            ['AFT DEC 2000', 'after desember 2000'],
            ['BEF DEC 2000', 'before desember 2000'],
            ['2000', '2000'],
            ['ABT 15 JAN 2000', 'about 15 januar 2000'],
            ['CAL 15 JAN 2000', 'calculated 15 januar 2000'],
            ['EST 15 JAN 2000', 'estimated 15 januar 2000'],
            ['BEF 15 JAN 2000', 'before 15 januar 2000'],
            ['AFT 15 JAN 2000', 'after 15 januar 2000'],
            ['FROM 15 JAN 2000', 'from 15 januar 2000'],
            ['TO 15 JAN 2000', 'to 15 januar 2000'],
            ['BET 15 JAN 2000 AND 15 FEB 2000', 'between 15 januar 2000 and 15 februar 2000'],
            ['FROM 15 JAN 2000 TO 15 FEB 2000', 'from 15 januar 2000 to 15 februar 2000'],
            ['INT 15 JAN 2000', 'interpreted 15 januar 2000'],
            ['@#DJULIAN@ 15 JAN 1700', '15 januar 1700 ᴄᴇ'],
            ['@#DJULIAN@ JAN 1700', 'januar 1700 ᴄᴇ'],
            ['ABT @#DJULIAN@ JAN 1700', 'about januar 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ JAN 1700', 'from januar 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ JAN 1700', 'after januar 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ JAN 1700', 'before januar 1700 ᴄᴇ'],
            ['@#DJULIAN@ 15 FEB 1700', '15 februar 1700 ᴄᴇ'],
            ['@#DJULIAN@ FEB 1700', 'februar 1700 ᴄᴇ'],
            ['ABT @#DJULIAN@ FEB 1700', 'about februar 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ FEB 1700', 'from februar 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ FEB 1700', 'after februar 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ FEB 1700', 'before februar 1700 ᴄᴇ'],
            ['@#DJULIAN@ 15 MAR 1700', '15 mars 1700 ᴄᴇ'],
            ['@#DJULIAN@ MAR 1700', 'mars 1700 ᴄᴇ'],
            ['ABT @#DJULIAN@ MAR 1700', 'about mars 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ MAR 1700', 'from mars 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ MAR 1700', 'after mars 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ MAR 1700', 'before mars 1700 ᴄᴇ'],
            ['@#DJULIAN@ 15 APR 1700', '15 apríl 1700 ᴄᴇ'],
            ['@#DJULIAN@ 14 APR 1645/46', '14 apríl 1645/46 ᴄᴇ'],
            ['@#DJULIAN@ APR 1700', 'apríl 1700 ᴄᴇ'],
            ['ABT @#DJULIAN@ APR 1700', 'about apríl 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ APR 1700', 'from apríl 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ APR 1700', 'after apríl 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ APR 1700', 'before apríl 1700 ᴄᴇ'],
            ...
            ['ABT @#DJULIAN@ JUL 1700', 'about juli 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ JUL 1700', 'from juli 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ JUL 1700', 'after juli 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ JUL 1700', 'before juli 1700 ᴄᴇ'],
            ...
            ['@#DJULIAN@ 15 OCT 1700', '15 oktober 1700 ᴄᴇ'],
            ['@#DJULIAN@ OCT 1700', 'oktober 1700 ᴄᴇ'],
            ['ABT @#DJULIAN@ OCT 1700', 'about oktober 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ OCT 1700', 'from oktober 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ OCT 1700', 'after oktober 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ OCT 1700', 'before oktober 1700 ᴄᴇ'],
            ...
            ['@#DJULIAN@ 15 DEC 1700', '15 desember 1700 ᴄᴇ'],
            ['@#DJULIAN@ DEC 1700', 'desember 1700 ᴄᴇ'],
            ['ABT @#DJULIAN@ DEC 1700', 'about desember 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ DEC 1700', 'from desember 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ DEC 1700', 'after desember 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ DEC 1700', 'before desember 1700 ᴄᴇ'],
            ['@#DJULIAN@ 1700', '1700 ᴄᴇ'],
            ['ABT @#DJULIAN@ 15 JAN 1700', 'about 15 januar 1700 ᴄᴇ'],
            ['CAL @#DJULIAN@ 15 JAN 1700', 'calculated 15 januar 1700 ᴄᴇ'],
            ['EST @#DJULIAN@ 15 JAN 1700', 'estimated 15 januar 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ 15 JAN 1700', 'before 15 januar 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ 15 JAN 1700', 'after 15 januar 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ 15 JAN 1700', 'from 15 januar 1700 ᴄᴇ'],
            ['TO @#DJULIAN@ 15 JAN 1700', 'to 15 januar 1700 ᴄᴇ'],
            ['BET @#DJULIAN@ 15 JAN 1700 AND @#DJULIAN@ 15 FEB 1700', 'between 15 januar 1700 ᴄᴇ and 15 februar 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ 15 JAN 1700 TO @#DJULIAN@ 15 FEB 1700', 'from 15 januar 1700 ᴄᴇ to 15 februar 1700 ᴄᴇ'],
            ['INT @#DJULIAN@ 15 JAN 1700', 'interpreted 15 januar 1700 ᴄᴇ'],
