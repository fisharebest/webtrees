...
#[CoversClass(NorwegianBokmal::class)]
class NorwegianBokmalTest extends AbstractLanguageTestCase
{
    protected static function language(): LanguageInterface
    {
        return new NorwegianBokmal();
    }
    ...
    {
        self::assertSame('nb', self::language()->languageTag());
    }
    public function testEndonym(): void
    {
        self::assertSame('norsk bokml', self::language()->endonym());
    }
    ...
    {
        self::assertSame("-123\u{202F}456,0789", self::language()->number(-123456.0789));
    }

    public function testPercentage(): void
    {
        self::assertSame("-123\u{202F}456,0789%", self::language()->percentage(-1234.560789));
    }
    ...
    public static function dateProvider(): array
    {
        return [
            ...
            ['MAR 2000', 'mars 2000'],
            ['ABT MAR 2000', 'omkring mars 2000'],
            ['FROM MAR 2000', 'fra mars 2000'],
            ...
            ['MAY 2000', 'mai 2000'],
            ['ABT MAY 2000', 'omkring mai 2000'],
            ['FROM MAY 2000', 'fra mai 2000'],
            ...
            ['ABT DEC 2000', 'omkring desember 2000'],
            ['FROM DEC 2000', 'fra desember 2000'],
            ...
            ['EST 15 JAN 2000', 'beregnet 15. januar 2000'],
            ...
            ['INT 15 JAN 2000', 'antatt 15. januar 2000'],
            ['@#DJULIAN@ 15 JAN 1700', '15. januar 1700 evt. Juliansk kalender'],
            ['@#DJULIAN@ JAN 1700', 'januar 1700 evt. Juliansk kalender'],
            ['ABT @#DJULIAN@ JAN 1700', 'omkring januar 1700 evt. Juliansk kalender'],
            ['FROM @#DJULIAN@ JAN 1700', 'fra januar 1700 evt. Juliansk kalender'],
            ...
            ['ABT @#DJULIAN@ FEB 1700', 'omkring februar 1700 evt. Juliansk kalender'],
            ['FROM @#DJULIAN@ FEB 1700', 'fra februar 1700 evt. Juliansk kalender'],
            ...
            ['ABT @#DJULIAN@ MAR 1700', 'omkring mars 1700 evt. Juliansk kalender'],
            ['FROM @#DJULIAN@ MAR 1700', 'fra mars 1700 evt. Juliansk kalender'],
            ...
            ['ABT @#DJULIAN@ APR 1700', 'omkring april 1700 evt. Juliansk kalender'],
            ['FROM @#DJULIAN@ APR 1700', 'fra april 1700 evt. Juliansk kalender'],
            ...
            ['ABT @#DJULIAN@ MAY 1700', 'omkring mai 1700 evt. Juliansk kalender'],
            ['FROM @#DJULIAN@ MAY 1700', 'fra mai 1700 evt. Juliansk kalender'],
            ...
            ['ABT @#DJULIAN@ JUN 1700', 'omkring juni 1700 evt. Juliansk kalender'],
            ['FROM @#DJULIAN@ JUN 1700', 'fra juni 1700 evt. Juliansk kalender'],
            ...
            ['ABT @#DJULIAN@ JUL 1700', 'omkring juli 1700 evt. Juliansk kalender'],
            ['FROM @#DJULIAN@ JUL 1700', 'fra juli 1700 evt. Juliansk kalender'],
            ...
            ['ABT @#DJULIAN@ AUG 1700', 'omkring august 1700 evt. Juliansk kalender'],
            ['FROM @#DJULIAN@ AUG 1700', 'fra august 1700 evt. Juliansk kalender'],
            ...
            ['ABT @#DJULIAN@ SEP 1700', 'omkring september 1700 evt. Juliansk kalender'],
            ['FROM @#DJULIAN@ SEP 1700', 'fra september 1700 evt. Juliansk kalender'],
            ...
            ['ABT @#DJULIAN@ OCT 1700', 'omkring oktober 1700 evt. Juliansk kalender'],
            ['FROM @#DJULIAN@ OCT 1700', 'fra oktober 1700 evt. Juliansk kalender'],
            ...
            ['ABT @#DJULIAN@ NOV 1700', 'omkring november 1700 evt. Juliansk kalender'],
            ['FROM @#DJULIAN@ NOV 1700', 'fra november 1700 evt. Juliansk kalender'],
            ...
            ['ABT @#DJULIAN@ DEC 1700', 'omkring desember 1700 evt. Juliansk kalender'],
            ['FROM @#DJULIAN@ DEC 1700', 'fra desember 1700 evt. Juliansk kalender'],
            ...
            ['ABT @#DJULIAN@ 15 JAN 1700', 'omkring 15. januar 1700 evt. Juliansk kalender'],
            ['CAL @#DJULIAN@ 15 JAN 1700', 'beregnet 15. januar 1700 evt. Juliansk kalender'],
            ['EST @#DJULIAN@ 15 JAN 1700', 'beregnet 15. januar 1700 evt. Juliansk kalender'],
            ...
            ['FROM @#DJULIAN@ 15 JAN 1700', 'fra 15. januar 1700 evt. Juliansk kalender'],
            ...
            ['FROM @#DJULIAN@ 15 JAN 1700 TO @#DJULIAN@ 15 FEB 1700', 'fra 15. januar 1700 evt. Juliansk kalender til 15. februar 1700 evt. Juliansk kalender'],
            ['INT @#DJULIAN@ 15 JAN 1700', 'antatt 15. januar 1700 evt. Juliansk kalender'],
            ...
            ['ABT @#DHEBREW@ NSN 5765', 'omkring Nisan 5765'],
            ['FROM @#DHEBREW@ NSN 5765', 'fra Nisan 5765'],
            ...
            ['EST @#DHEBREW@ 15 TSH 5765', 'beregnet 15. Tishrei 5765'],
            ...
            ['INT @#DHEBREW@ 15 TSH 5765', 'antatt 15. Tishrei 5765'],
            ...
            ['EST @#DFRENCH R@ 15 VEND 12', 'beregnet 15. Vendémiaire An XII'],
            ...
            ['INT @#DFRENCH R@ 15 VEND 12', 'antatt 15. Vendémiaire An XII'],
            ...
            ['EST @#DHIJRI@ 15 MUHAR 1425', 'beregnet 15. Muharram 1425'],
            ...
            ['INT @#DHIJRI@ 15 MUHAR 1425', 'antatt 15. Muharram 1425'],
            ...
            ['EST @#DJALALI@ 15 FARVA 1384', 'beregnet 15. Farvardin 1384'],
            ...
            ['INT @#DJALALI@ 15 FARVA 1384', 'antatt 15. Farvardin 1384'],
        ];
    }
    ...
    public function testRelationships(): void
    {
        ...
        // Parents
        self::assertRelationshipNames('mor', 'sønn', [$son, $fm, $wife]);
        self::assertRelationshipNames('far', 'sønn', [$son, $fm, $husband]);
        ...
        self::assertRelationshipName('stedatter', [$husband, $fm, $wife, $fd, $stepDaughter]);

        // In-laws
        self::assertRelationshipNames('svigermor', 'svigersønn', [$husband, $fm, $wife, $fw, $motherOfW]);
        self::assertRelationshipNames('svigerfar', 'svigersønn', [$husband, $fm, $wife, $fw, $fatherOfW]);
