...
class FrenchCanadaTest extends AbstractFrenchTestCase
{
    ...
    public static function dateProvider(): array
    {
        return [
            ...
            ['FROM APR 2000', 'à partir de avril 2000'],
            ...
            ['FROM AUG 2000', 'à partir de août 2000'],
            ...
            ['FROM OCT 2000', 'à partir de octobre 2000'],
            ...
            ['FROM @#DJULIAN@ APR 1700', 'à partir de avril 1700 De cette ère'],
            ...
            ['FROM @#DJULIAN@ AUG 1700', 'à partir de août 1700 De cette ère'],
            ...
            ['FROM @#DJULIAN@ OCT 1700', 'à partir de octobre 1700 De cette ère'],
            ...
            ['FROM @#DHEBREW@ ADR 5765', 'à partir de Adar I 5765'],
            ...
            ['FROM @#DHEBREW@ ADS 5765', 'à partir de Adar II 5765'],
            ...
            ['FROM @#DHEBREW@ IYR 5765', 'à partir de Iyar 5765'],
            ...
            ['FROM @#DHEBREW@ AAV 5765', 'à partir de Av 5765'],
            ...
            ['FROM @#DHEBREW@ ELL 5765', 'à partir de Eloul 5765'],
            ...
            ['FROM @#DJALALI@ ORDIB 1384', 'à partir de Ordibehesht 1384'],
            ...
            ['FROM @#DJALALI@ ABAN 1384', 'à partir de Aban 1384'],
            ...
            ['FROM @#DJALALI@ AZAR 1384', 'à partir de Azar 1384'],
            ...
            ['FROM @#DJALALI@ ESFAN 1384', 'à partir de Esfand 1384'],
