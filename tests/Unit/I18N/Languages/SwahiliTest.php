...
#[CoversClass(Swahili::class)]
class SwahiliTest extends AbstractLanguageTestCase
{
    ...
    {
        self::assertSame('sw', self::language()->languageTag());
    }
    public function testEndonym(): void
    {
        self::assertSame('Kiswahili', self::language()->endonym());
    }
    ...
    public static function dateProvider(): array
    {
        return [
            ...
            ['15 MAR 2000', '15 Machi 2000'],
            ['MAR 2000', 'Machi 2000'],
            ['ABT MAR 2000', 'about Machi 2000'],
            ['FROM MAR 2000', 'from Machi 2000'],
            ['AFT MAR 2000', 'after Machi 2000'],
            ['BEF MAR 2000', 'before Machi 2000'],
            ['15 APR 2000', '15 Aprili 2000'],
            ['APR 2000', 'Aprili 2000'],
            ['ABT APR 2000', 'about Aprili 2000'],
            ['FROM APR 2000', 'from Aprili 2000'],
            ['AFT APR 2000', 'after Aprili 2000'],
            ['BEF APR 2000', 'before Aprili 2000'],
            ...
            ['JUN 2000', 'Juni 2000'],
            ['ABT JUN 2000', 'about Juni 2000'],
            ['FROM JUN 2000', 'from Juni 2000'],
            ['AFT JUN 2000', 'after Juni 2000'],
            ['BEF JUN 2000', 'before Juni 2000'],
            ...
            ['15 AUG 2000', '15 Agosti 2000'],
            ['AUG 2000', 'Agosti 2000'],
            ['ABT AUG 2000', 'about Agosti 2000'],
            ['FROM AUG 2000', 'from Agosti 2000'],
            ['AFT AUG 2000', 'after Agosti 2000'],
            ['BEF AUG 2000', 'before Agosti 2000'],
            ['15 SEP 2000', '15 Septemba 2000'],
            ['SEP 2000', 'Septemba 2000'],
            ['ABT SEP 2000', 'about Septemba 2000'],
            ['FROM SEP 2000', 'from Septemba 2000'],
            ['AFT SEP 2000', 'after Septemba 2000'],
            ['BEF SEP 2000', 'before Septemba 2000'],
            ['15 OCT 2000', '15 Oktoba 2000'],
            ['OCT 2000', 'Oktoba 2000'],
            ['ABT OCT 2000', 'about Oktoba 2000'],
            ['FROM OCT 2000', 'from Oktoba 2000'],
            ['AFT OCT 2000', 'after Oktoba 2000'],
            ['BEF OCT 2000', 'before Oktoba 2000'],
            ['15 NOV 2000', '15 Novemba 2000'],
            ['NOV 2000', 'Novemba 2000'],
            ['ABT NOV 2000', 'about Novemba 2000'],
            ['FROM NOV 2000', 'from Novemba 2000'],
            ['AFT NOV 2000', 'after Novemba 2000'],
            ['BEF NOV 2000', 'before Novemba 2000'],
            ['15 DEC 2000', '15 Desemba 2000'],
            ['DEC 2000', 'Desemba 2000'],
            ['ABT DEC 2000', 'about Desemba 2000'],
            ['FROM DEC 2000', 'from Desemba 2000'],
            ['AFT DEC 2000', 'after Desemba 2000'],
            ['BEF DEC 2000', 'before Desemba 2000'],
            ['2000', '2000'],
            ...
            ['ABT @#DJULIAN@ JAN 1700', 'about Januari 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ JAN 1700', 'from Januari 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ JAN 1700', 'after Januari 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ JAN 1700', 'before Januari 1700 ᴄᴇ'],
            ['@#DJULIAN@ 15 FEB 1700', '15 Februari 1700 ᴄᴇ'],
            ['@#DJULIAN@ FEB 1700', 'Februari 1700 ᴄᴇ'],
            ['ABT @#DJULIAN@ FEB 1700', 'about Februari 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ FEB 1700', 'from Februari 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ FEB 1700', 'after Februari 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ FEB 1700', 'before Februari 1700 ᴄᴇ'],
            ['@#DJULIAN@ 15 MAR 1700', '15 Machi 1700 ᴄᴇ'],
            ['@#DJULIAN@ MAR 1700', 'Machi 1700 ᴄᴇ'],
            ['ABT @#DJULIAN@ MAR 1700', 'about Machi 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ MAR 1700', 'from Machi 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ MAR 1700', 'after Machi 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ MAR 1700', 'before Machi 1700 ᴄᴇ'],
            ['@#DJULIAN@ 15 APR 1700', '15 Aprili 1700 ᴄᴇ'],
            ['@#DJULIAN@ 14 APR 1645/46', '14 Aprili 1645/46 ᴄᴇ'],
            ['@#DJULIAN@ APR 1700', 'Aprili 1700 ᴄᴇ'],
            ['ABT @#DJULIAN@ APR 1700', 'about Aprili 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ APR 1700', 'from Aprili 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ APR 1700', 'after Aprili 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ APR 1700', 'before Aprili 1700 ᴄᴇ'],
            ...
            ['ABT @#DJULIAN@ JUN 1700', 'about Juni 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ JUN 1700', 'from Juni 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ JUN 1700', 'after Juni 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ JUN 1700', 'before Juni 1700 ᴄᴇ'],
            ['@#DJULIAN@ 15 JUL 1700', '15 Julai 1700 ᴄᴇ'],
            ['@#DJULIAN@ JUL 1700', 'Julai 1700 ᴄᴇ'],
            ['ABT @#DJULIAN@ JUL 1700', 'about Julai 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ JUL 1700', 'from Julai 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ JUL 1700', 'after Julai 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ JUL 1700', 'before Julai 1700 ᴄᴇ'],
            ['@#DJULIAN@ 15 AUG 1700', '15 Agosti 1700 ᴄᴇ'],
            ['@#DJULIAN@ AUG 1700', 'Agosti 1700 ᴄᴇ'],
            ['ABT @#DJULIAN@ AUG 1700', 'about Agosti 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ AUG 1700', 'from Agosti 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ AUG 1700', 'after Agosti 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ AUG 1700', 'before Agosti 1700 ᴄᴇ'],
            ['@#DJULIAN@ 15 SEP 1700', '15 Septemba 1700 ᴄᴇ'],
            ['@#DJULIAN@ SEP 1700', 'Septemba 1700 ᴄᴇ'],
            ['ABT @#DJULIAN@ SEP 1700', 'about Septemba 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ SEP 1700', 'from Septemba 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ SEP 1700', 'after Septemba 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ SEP 1700', 'before Septemba 1700 ᴄᴇ'],
            ['@#DJULIAN@ 15 OCT 1700', '15 Oktoba 1700 ᴄᴇ'],
            ['@#DJULIAN@ OCT 1700', 'Oktoba 1700 ᴄᴇ'],
            ['ABT @#DJULIAN@ OCT 1700', 'about Oktoba 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ OCT 1700', 'from Oktoba 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ OCT 1700', 'after Oktoba 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ OCT 1700', 'before Oktoba 1700 ᴄᴇ'],
            ['@#DJULIAN@ 15 NOV 1700', '15 Novemba 1700 ᴄᴇ'],
            ['@#DJULIAN@ NOV 1700', 'Novemba 1700 ᴄᴇ'],
            ['ABT @#DJULIAN@ NOV 1700', 'about Novemba 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ NOV 1700', 'from Novemba 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ NOV 1700', 'after Novemba 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ NOV 1700', 'before Novemba 1700 ᴄᴇ'],
            ['@#DJULIAN@ 15 DEC 1700', '15 Desemba 1700 ᴄᴇ'],
            ['@#DJULIAN@ DEC 1700', 'Desemba 1700 ᴄᴇ'],
            ['ABT @#DJULIAN@ DEC 1700', 'about Desemba 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ DEC 1700', 'from Desemba 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ DEC 1700', 'after Desemba 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ DEC 1700', 'before Desemba 1700 ᴄᴇ'],
            ['@#DJULIAN@ 1700', '1700 ᴄᴇ'],
            ['ABT @#DJULIAN@ 15 JAN 1700', 'about 15 Januari 1700 ᴄᴇ'],
            ['CAL @#DJULIAN@ 15 JAN 1700', 'calculated 15 Januari 1700 ᴄᴇ'],
            ['EST @#DJULIAN@ 15 JAN 1700', 'estimated 15 Januari 1700 ᴄᴇ'],
            ['BEF @#DJULIAN@ 15 JAN 1700', 'before 15 Januari 1700 ᴄᴇ'],
            ['AFT @#DJULIAN@ 15 JAN 1700', 'after 15 Januari 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ 15 JAN 1700', 'from 15 Januari 1700 ᴄᴇ'],
            ['TO @#DJULIAN@ 15 JAN 1700', 'to 15 Januari 1700 ᴄᴇ'],
            ['BET @#DJULIAN@ 15 JAN 1700 AND @#DJULIAN@ 15 FEB 1700', 'between 15 Januari 1700 ᴄᴇ and 15 Februari 1700 ᴄᴇ'],
            ['FROM @#DJULIAN@ 15 JAN 1700 TO @#DJULIAN@ 15 FEB 1700', 'from 15 Januari 1700 ᴄᴇ to 15 Februari 1700 ᴄᴇ'],
            ['INT @#DJULIAN@ 15 JAN 1700', 'interpreted 15 Januari 1700 ᴄᴇ'],
    ...
    public function testFormatList(): void
    {
        ...
        self::assertSame('one au two', $language->formatListOr(['one', 'two']));
        self::assertSame('one, two au three', $language->formatListOr(['one', 'two', 'three']));
    }
    ...
    public function testRelationships(): void
    {
        ...
        // Partners
        self::assertRelationshipNames('mke', 'mume', [$husband, $fm, $wife]);
        self::assertRelationshipNames('mume wa zamani', 'mke wa zamani', [$wife, $fd, $exHusband]);
        self::assertRelationshipNames('mchumba wa kike', 'mchumba wa kiume', [$fiance, $fe, $engaged]);

        // Parents / Children
        self::assertRelationshipNames('mama', 'mwana', [$son, $fm, $wife]);
        self::assertRelationshipNames('baba', 'mwana', [$son, $fm, $husband]);
        self::assertRelationshipNames('mama', 'binti', [$daughter, $fm, $wife]);

        // Adopted / Fostered
        self::assertRelationshipNames('mama mlezi', 'mwana wa kuasili', [$adoptedSon, $fd, $wife]);
        self::assertRelationshipNames('mama mlea', 'binti mlea', [$fosterDaughter, $fd, $wife]);

        // Siblings
        self::assertRelationshipNames('dada', 'kaka', [$son, $fm, $daughter]);
        self::assertRelationshipNames('kaka', 'dada', [$daughter, $fm, $son]);

        // Stepfamily
        self::assertRelationshipName('baba wa kambo', [$stepDaughter, $fd, $wife, $fm, $husband]);
        self::assertRelationshipName('binti wa kambo', [$husband, $fm, $wife, $fd, $stepDaughter]);

        // In-laws — spouse's parents
        self::assertRelationshipName('mama mkwe', [$husband, $fm, $wife, $fw, $motherOfW]);
        self::assertRelationshipName('baba mkwe', [$husband, $fm, $wife, $fw, $fatherOfW]);
        self::assertRelationshipName('mama mkwe', [$wife, $fm, $husband, $fp, $motherOfH]);
        self::assertRelationshipName('baba mkwe', [$wife, $fm, $husband, $fp, $fatherOfH]);

        // In-laws — child's spouse
        self::assertRelationshipName('mkwe wa kike', [$husband, $fm, $son, $fson, $wifeOfSon]);
        self::assertRelationshipName('mkwe wa kiume', [$husband, $fm, $daughter, $fdau, $husbandOfDaughter]);

        // In-laws — spouse's siblings
        self::assertRelationshipName('shemeji', [$husband, $fm, $wife, $fw, $brotherOfW]);
        self::assertRelationshipName('wifi', [$husband, $fm, $wife, $fw, $sisterOfW]);

        // Grandparents
        self::assertRelationshipName('bibi', [$son, $fm, $husband, $fp, $motherOfH]);
        self::assertRelationshipName('babu', [$son, $fm, $husband, $fp, $fatherOfH]);
        self::assertRelationshipName('bibi', [$son, $fm, $wife, $fw, $motherOfW]);
        self::assertRelationshipName('babu', [$son, $fm, $wife, $fw, $fatherOfW]);

        // Grandchildren
        self::assertRelationshipName('mjukuu wa kiume', [$fatherOfH, $fp, $husband, $fm, $son]);
        self::assertRelationshipName('mjukuu wa kike', [$fatherOfH, $fp, $husband, $fm, $daughter]);

        // Aunts/Uncles
        self::assertRelationshipName('shangazi', [$son, $fm, $husband, $fp, $sisterOfH]);
        self::assertRelationshipName('baba mdogo', [$son, $fm, $husband, $fp, $brotherOfH]);
        self::assertRelationshipName('mjomba', [$son, $fm, $wife, $fw, $brotherOfW]);
        self::assertRelationshipName('mama mdogo', [$son, $fm, $wife, $fw, $sisterOfW]);

        // Nieces/Nephews
        self::assertRelationshipName('mpwa wa kike', [$husband, $fp, $brotherOfH, $fbro, $nieceFromBro]);
        self::assertRelationshipName('mpwa wa kiume', [$husband, $fp, $brotherOfH, $fbro, $nephewFromBro]);
        self::assertRelationshipName('mpwa wa kike', [$husband, $fp, $sisterOfH, $fsis, $nieceFromSis]);
        self::assertRelationshipName('mpwa wa kiume', [$husband, $fp, $sisterOfH, $fsis, $nephewFromSis]);

        // Cousins
        self::assertRelationshipName('binamu wa kiume', [$son, $fm, $husband, $fp, $brotherOfH, $fbro, $cousinM]);
        self::assertRelationshipName('binamu wa kike', [$son, $fm, $husband, $fp, $sisterOfH, $fsis, $cousinF]);

        // Great-grandparents (dynamic)
        self::assertRelationshipName('bibi mkubwa', [$son, $fm, $husband, $fp, $motherOfH, $fgp, $paternalGM]);
        self::assertRelationshipName('babu mkubwa', [$son, $fm, $husband, $fp, $motherOfH, $fgp, $paternalGF]);

        // Great-aunt/uncle (dynamic — grandparent's sibling, n=2)
        self::assertRelationshipName('shangazi', [$son, $fm, $husband, $fp, $motherOfH, $fgp, $greatAunt]);
        self::assertRelationshipName('mjomba', [$son, $fm, $husband, $fp, $motherOfH, $fgp, $greatUncle]);
    }
}
