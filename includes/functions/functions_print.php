	...
	if ($sub) {
		...
		if (!empty($placerec)) {
			...
			if ($map_lati && $map_long && empty($SEARCH_SPIDER)) {
				...
				$html.=' <a target="_BLANK" href="'."http://maps.google.com/maps?q={$map_lati},{$map_long}(".rawurlencode($place).")".'"><img src="images/bubble.gif" border="0" alt="Google Maps™" title="Google Maps™" /></a>';
