...
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('<b>webtrees</b> will check the permissions in the next step.');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('Add an unlinked shared note');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('Add child');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('Add daughter');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('Add son');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('After you have copied this file to the webserver and set the access permissions, click here to continue');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('Automatically protect new images');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('By clicking this link, you can add a <u>new</u> child to this person, creating a one-parent family.<br /><br />Just click the link, and you will get a pop up window to add the new person.  Fill out as many boxes as you can and click the <b>Save</b> button.<br /><br />That\'s all.');
...
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('No CHAN (Last Change) records were updated');
...
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('The directory <b>%s</b> does not have write permission.  You must change this.');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('The directory <b>%s</b> has read-write permission.  Good.');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('The file <b>%s</b> does not have read permission.  You must change this.');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('The file <b>%s</b> has read-only permission.  Good.');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('The file <b>%s</b> has write permission.  This will work, but for better security, you should make it read only.');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('This is the most important field in a person\'s Name record.<br /><br />This field should be filled automatically as the other fields are filled in, but it is provided so that you can edit the information according to your personal preference.<br /><br />The name in this field should be entered according to the GEDCOM 5.5.1 standards with the surname surrounded by forward slashes "/".  As an example, the name "John Robert Finlay Jr." should be entered like this: "John Robert /Finlay/ Jr.".');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('This item will allow you to link the current individual as a husband to a family that is already in the database. By clicking this link you can add this person to an existing family, of which the husband was unknown until now. This person will take the place of the previously unknown husband. All events, marriage information, and children will keep their existing links to the family.<br /><br />Just click the link, enter the ID of the family, and you have competed the task. This is an advanced editing option that should only be used if the family you want to link to already exists.  If you want to add a <u>new</u> family to this individual, use the <b>Add a new wife</b> link.');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('This item will allow you to link the current individual as a wife to a family that is already in the database.<br /><br />This is an advanced editing option that should only be used if the family you want to link to already exists.  If you want to add a <u>new</u> family to this individual, use the <b>Add a new husband</b> link.');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('This link already exists');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('This optional field allows you to enter a name prefix such as "Dr." or "Adm."');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('This will allow you to link another individual, who already exists, as a new husband to this person.  This will create a new family with the husband you select.  You will also have the option of specifying a marriage for this new family.');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('This will allow you to link another individual, who already exists, as a new wife to this person.  This will create a new family with the wife you select.  You will also have the option of specifying a marriage for this new family.');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('Use this form to add an unlinked person.<br /><br />When you add an unlinked person to your family tree, the person will not be linked to any other people until you link them.  Later, you can link people together from the Close Relatives tab on the Individual Information page.');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('Use this link to add a new shared note to your database without linking the note to any record.<br /><br />The new note will appear in the Shared Note list, but will not appear on any charts or anywhere else in the program until it is linked to an individual, family or event.');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('Use this link to add a new source to your database without linking the source to a source citation in another record.  The new source will appear in the source list, but will not appear on any charts or anywhere else in the program until it is linked up to a source citation.');
...
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('With this page you can add a new child to the selected family.  Fill out the name of the child and the birth and death information if it is known.  If you don\'t know some information leave it blank.<br /><br />To add other facts besides birth and death, first add the new child to the database by saving the changes.  Then click on the child\'s name in the updated Family page or Close Relatives tab to view the child\'s Individual Information page.  From the Individual Information page you can add more detailed information.');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('With this page you can add a new husband or wife to the selected person.  Fill out the new person\'s name and the birth and death information if it is known.  If you don\'t know some information leave it blank.<br /><br />To add other facts besides birth and death, first add the new person to the database by saving the changes.  Then click on the person\'s name in the updated Family page or Close Relatives tab to view the person\'s Individual Information page.  From the Individual Information page you can add more detailed information.');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('With this page you can add a new husband or wife to the selected person.  Fill out the new person\'s name and the birth and death information if it is known.  If you don\'t know some information leave it blank.<br /><br />To add other facts besides birth and death, first add the new person to the database by saving the changes.  Then click on the person\'s name in the updated Family page or Close Relatives tab to view the person\'s Individual Information page.  From the Individual Information page you can add more detailed information.');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('With this page you can add a new mother or father to the selected person.  Fill out the new person\'s name and the birth and death information if it is known.  If you don\'t know some information, leave it blank.<br /><br />To add other facts besides birth and death, first add the new person to the database by saving the changes.  Then click on the person\'s name in the updated Family page or Close Relatives tab to view the person\'s Individual Information page.  From the Individual Information page you can add more detailed information.');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('You can link this person as a child to an existing family when you click this link.<br /><br />Suppose that at one time the parents of the person were unknown, and you discovered later that the parents have a record in this database.<br /><br />Just click the link, enter the ID of the family, and you have competed the task.  If you don\'t know the family\'s ID, you can search for it.');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('You should set the directory <b>%s</b> so that the webserver has read-write access.<br/>This normally means setting the permissions to "777" or "drwxrwxrwx".');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('You should set the file <b>%s</b> so that the webserver has read-only access.<br/>This normally means setting the permissions to "444" or "-r--r--r--".');
/* I18N: This message is deleted in webtrees-1.3.3  */ WT_I18N::translate('Your system is almost ready for use.  The final step is to download a configuration file <b>%1$s</b> and copy this to the <b>%2$s</b> directory on your webserver.  This is a security measure to ensure only the website\'s owner can configure it.');
