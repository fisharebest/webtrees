...
$router->attach('', '/tree/{tree}', static function (Map $router) {
    ...
    $router->post(CopyFact::class, '/copy-fact/{xref}/{fact_id}', CopyFact::class);
    $router->post(DeleteRecord::class, '/delete-record/{xref}', DeleteRecord::class);
    $router->post(DeleteFact::class, '/delete-fact/{xref}/{fact_id}', DeleteFact::class);
    $router->get(EditRawFactPage::class, '/edit-raw-fact/{xref}/{fact_id}', EditRawFactPage::class);
    $router->post(EditRawFactAction::class, '/edit-raw-fact/{xref}/{fact_id}', EditRawFactAction::class);
    $router->get(EditRawRecordPage::class, '/edit-raw-record', EditRawRecordPage::class);
    $router->post(EditRawRecordAction::class, '/edit-raw-record', EditRawRecordAction::class);
