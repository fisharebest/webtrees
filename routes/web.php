...
if (Auth::isAdmin()) {
    ...
    $router->post('modules', '/modules', 'Admin\ModuleController::update');
    $router->get('analytics', '/analytics', 'Admin\ModuleController::listAnalytics');
    $router->post('analytics', '/analytics', 'Admin\ModuleController::updateAnalytics');
    $router->get('blocks', '/blocks', 'Admin\ModuleController::listBlocks');
    $router->post('blocks', '/blocks', 'Admin\ModuleController::updateBlocks');
    $router->get('charts', '/charts', 'Admin\ModuleController::listCharts');
    $router->post('charts', '/charts', 'Admin\ModuleController::updateCharts');
    $router->get('lists', '/lists', 'Admin\ModuleController::listLists');
    $router->post('lists', '/lists', 'Admin\ModuleController::updateLists');
    $router->get('footers', '/footers', 'Admin\ModuleController::listFooters');
    $router->post('footers', '/footers', 'Admin\ModuleController::updateFooters');
    $router->get('history', '/history', 'Admin\ModuleController::listHistory');
    $router->post('history', '/history', 'Admin\ModuleController::updateHistory');
    $router->get('menus', '/menus', 'Admin\ModuleController::listMenus');
    $router->post('menus', '/menus', 'Admin\ModuleController::updateMenus');
    $router->get('languages', '/languages', 'Admin\ModuleController::listLanguages');
    $router->post('languages', '/languages', 'Admin\ModuleController::updateLanguages');
    $router->get('reports', '/reports', 'Admin\ModuleController::listReports');
    $router->post('reports', '/reports', 'Admin\ModuleController::updateReports');
    $router->get('sidebars', '/sidebars', 'Admin\ModuleController::listSidebars');
    $router->post('sidebars', '/sidebars', 'Admin\ModuleController::updateSidebars');
    $router->get('themes', '/themes', 'Admin\ModuleController::listThemes');
    $router->post('themes', '/themes', 'Admin\ModuleController::updateThemes');
    $router->get('tabs', '/tabs', 'Admin\ModuleController::listTabs');
    $router->post('tabs', '/tabs', 'Admin\ModuleController::updateTabs');
    ...
    $router->post('map-data-edit', '/map-data-edit', 'Admin\LocationController::mapDataSave');
    ...
    $router->post('locations-import', '/locations-import', 'Admin\LocationController::importLocationsAction');
    ...
    $router->post('map-provider', '/map-provider', 'Admin\MapProviderController::mapProviderSave');
    ...
    $router->post('admin-media-upload', '/admin-media-upload', 'Admin\MediaController::uploadAction');
    $router->get('upgrade', '/upgrade', 'Admin\UpgradeController::wizard');
    $router->post('upgrade', '/upgrade', 'Admin\UpgradeController::step');
    ...
    $router->post('admin-users-create', '/admin-users-create', 'Admin\UsersController::save');
    $router->get('admin-users-edit', '/admin-users-edit', 'Admin\UsersController::edit');
    $router->post('admin-users-edit', '/admin-users-edit', 'Admin\UsersController::update');
    $router->get('admin-users-cleanup', '/admin-users-cleanup', 'Admin\UsersController::cleanup');
    $router->post('admin-users-cleanup', '/admin-users-cleanup', 'Admin\UsersController::cleanupAction');
    $router->get('admin-clean-data', '/admin-clean-data', 'AdminSiteController::cleanData');
    $router->post('admin-clean-data', '/admin-clean-data', 'AdminSiteController::cleanDataAction');
    $router->get('admin-site-preferences', '/admin-site-preferences', 'AdminSiteController::preferencesForm');
    $router->post('admin-site-preferences', '/admin-site-preferences', 'AdminSiteController::preferencesSave');
    $router->get('admin-site-mail', '/admin-site-mail', 'AdminSiteController::mailForm');
    $router->post('admin-site-mail', '/admin-site-mail', 'AdminSiteController::mailSave');
    $router->get('admin-site-registration', '/admin-site-registration', 'AdminSiteController::registrationForm');
    $router->post('admin-site-registration', '/admin-site-registration', 'AdminSiteController::registrationSave');
    ...
    $router->post('admin-trees-merge', '/admin-trees-merge', 'AdminTreesController::mergeAction');
    ...
    $router->post('broadcast', '/broadcast', 'MessageController::broadcastAction');
...
if ($tree instanceof Tree && Auth::isManager($tree)) {
    ...
    $router->post('admin-trees-export', '/admin-trees-export', 'AdminTreesController::exportServer');
    $router->get('admin-trees-import', '/admin-trees-import', 'AdminTreesController::importForm');
    $router->post('admin-trees-import', '/admin-trees-import', 'AdminTreesController::importAction');
    $router->get('admin-trees-places', '/admin-trees-places', 'AdminTreesController::places');
    $router->post('admin-trees-places', '/admin-trees-places', 'AdminTreesController::placesAction');
    $router->get('admin-trees-preferences', '/admin-trees-preferences', 'AdminTreesController::preferences');
    $router->post('admin-trees-preferences', '/admin-trees-preferences', 'AdminTreesController::preferencesUpdate');
    $router->get('admin-trees-renumber', '/admin-trees-renumber', 'AdminTreesController::renumber');
    $router->post('admin-trees-renumber', '/admin-trees-renumber', 'AdminTreesController::renumberAction');
    ...
    $router->post('merge-records', '/merge-records', 'AdminController::mergeRecordsAction');
    $router->get('tree-page-block-edit', '/tree-page-block-edit', 'HomePageController::treePageBlockEdit');
    $router->post('tree-page-block-edit', '/tree-page-block-edit', 'HomePageController::treePageBlockUpdate');
    $router->get('tree-preferences', '/tree-preferences', 'AdminController::treePreferencesEdit');
    $router->post('tree-preferences', '/tree-preferences', 'AdminController::treePreferencesUpdate');
    $router->get('tree-privacy', '/tree-privacy', 'AdminController::treePrivacyEdit');
    $router->post('tree-privacy', '/tree-privacy', 'AdminController::treePrivacyUpdate');
}
...
if ($tree instanceof Tree && $tree->getPreference('imported') === '1' && Auth::isEditor($tree)) {
    ...
    $router->post('add-media-file', '/add-media-file', 'EditMediaController::addMediaFileAction');
    $router->get('edit-media-file', '/edit-media-file', 'EditMediaController::editMediaFile');
    $router->post('edit-media-file', '/edit-media-file', 'EditMediaController::editMediaFileAction');
    $router->get('create-media-object', '/create-media-object', 'EditMediaController::createMediaObject');
    $router->post('create-media-object', '/create-media-object', 'EditMediaController::createMediaObjectAction');
    ...
    $router->post('create-note-object', '/create-note-object', 'EditNoteController::createNoteObjectAction');
    $router->get('edit-note-object', '/edit-note-object', 'EditNoteController::editNoteObject');
    $router->post('edit-note-object', '/edit-note-object', 'EditNoteController::updateNoteObject');
    $router->get('create-repository', '/create-repository', 'EditRepositoryController::createRepository');
    $router->post('create-repository', '/create-repository', 'EditRepositoryController::createRepositoryAction');
    $router->get('create-source', '/create-source', 'EditSourceController::createSource');
    $router->post('create-source', '/create-source', 'EditSourceController::createSourceAction');
    $router->get('create-submitter', '/create-submitter', 'EditSubmitterController::createSubmitter');
    $router->post('create-submitter', '/create-submitter', 'EditSubmitterController::createSubmitterAction');
    $router->get('reorder-children', '/reorder-children', 'EditFamilyController::reorderChildren');
    $router->post('reorder-children', '/reorder-children', 'EditFamilyController::reorderChildrenAction');
    $router->get('reorder-media', '/reorder-media', 'EditIndividualController::reorderMedia');
    $router->post('reorder-media', '/reorder-media', 'EditIndividualController::reorderMediaAction');
    $router->get('reorder-names', '/reorder-names', 'EditIndividualController::reorderNames');
    $router->post('reorder-names', '/reorder-names', 'EditIndividualController::reorderNamesAction');
    $router->get('reorder-spouses', '/reorder-spouses', 'EditIndividualController::reorderSpouses');
    $router->post('reorder-spouses', '/reorder-spouses', 'EditIndividualController::reorderSpousesAction');
    $router->get('edit-raw-record', '/edit-raw-record', 'EditGedcomRecordController::editRawRecord');
    $router->post('edit-raw-record', '/edit-raw-record', 'EditGedcomRecordController::editRawRecordAction');
    $router->get('edit-raw-fact', '/edit-raw-fact', 'EditGedcomRecordController::editRawFact');
    $router->post('edit-raw-fact', '/edit-raw-fact', 'EditGedcomRecordController::editRawFactAction');
    ...
    $router->post('search-replace', '/search-replace', 'SearchController::replaceAction');
    $router->get('add-child-to-family', '/add-child-to-family', 'EditFamilyController::addChild');
    $router->post('add-child-to-family', '/add-child-to-family', 'EditFamilyController::addChildAction');
    $router->get('add-spouse-to-family', '/add-spouse-to-family', 'EditFamilyController::addSpouse');
    $router->post('add-spouse-to-family', '/add-spouse-to-family', 'EditFamilyController::addSpouseAction');
    $router->get('change-family-members', '/change-family-members', 'EditFamilyController::changeFamilyMembers');
    $router->post('change-family-members', '/change-family-members', 'EditFamilyController::changeFamilyMembersAction');
    $router->get('add-child-to-individual', '/add-child-to-individual', 'EditIndividualController::addChild');
    $router->post('add-child-to-individual', '/add-child-to-individual', 'EditIndividualController::addChildAction');
    $router->get('add-parent-to-individual', '/add-parent-to-individual', 'EditIndividualController::addParent');
    $router->post('add-parent-to-individual', '/add-parent-to-individual', 'EditIndividualController::addParentAction');
    $router->get('add-spouse-to-individual', '/add-spouse-to-individual', 'EditIndividualController::addSpouse');
    $router->post('add-spouse-to-individual', '/add-spouse-to-individual', 'EditIndividualController::addSpouseAction');
    $router->get('add-unlinked-individual', '/add-unlinked-individual', 'EditIndividualController::addUnlinked');
    $router->post('add-unlinked-individual', '/add-unlinked-individual', 'EditIndividualController::addUnlinkedAction');
    $router->get('link-child-to-family', '/link-child-to-family', 'EditIndividualController::linkChildToFamily');
    $router->post('link-child-to-family', '/link-child-to-family', 'EditIndividualController::linkChildToFamilyAction');
    $router->get('link-spouse-to-individual', '/link-spouse-to-individual', 'EditIndividualController::linkSpouseToIndividual');
    $router->post('link-spouse-to-individual', '/link-spouse-to-individual', 'EditIndividualController::linkSpouseToIndividualAction');
    $router->get('edit-name', '/edit-name', 'EditIndividualController::editName');
    $router->post('edit-name', '/edit-name', 'EditIndividualController::editNameAction');
    $router->get('add-name', '/add-name', 'EditIndividualController::addName');
    $router->post('add-name', '/add-name', 'EditIndividualController::addNameAction');
}
...
if ($tree instanceof Tree && $tree->getPreference('imported') === '1' && Auth::isMember($tree)) {
    ...
    $router->post('user-page-block-edit', '/user-page-block-edit', 'HomePageController::userPageBlockUpdate');
    $router->get('my-account', '/my-account', 'AccountController::edit');
    $router->post('my-account', '/my-account', 'AccountController::update');
...
if ($tree instanceof Tree && $tree->getPreference('imported') === '1') {
    ...
    $router->post('contact', '/contact-action', 'MessageController::contactAction');
    $router->get('message', '/message', 'MessageController::messagePage');
    $router->post('message', '/message', 'MessageController::messageAction');
...
$router->post('logout-action', '/logout', Logout::class);
