...
<form class="wt-page-options wt-page-options-hourglass-chart d-print-none">
	<input type="hidden" name="route" value="hourglass">
...
<div class="wt-ajax-load wt-page-content wt-chart wt-hourglass-chart" data-ajax-url="<?= e(route('hourglass-chart', ['xref' => $individual->getXref(), 'generations' => $generations, 'show_spouse' => $show_spouse, 'ged' => $individual->getTree()->getName()])) ?>"></div>
