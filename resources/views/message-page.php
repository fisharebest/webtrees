...
<form method="post" action="<?= e(route('message')) ?>">
	<?= csrf_field() ?>
	...
	<div class="form-group row">
		...
		<div class="col-sm-9">
			<input type="hidden" name="to" value="<?= e($to->getUserName()) ?>">
			<input class="form-control" id="to" type="text" value="<?= e($to->getRealName()) ?>" disabled>
		</div>
	</div>
